...
if Redis:get(DyLer..'expsource') then
chsource = Redis:get(DyLer..'expsource')
else
expsource = "DGGEO"
end
...
local se = http.request("https://sero-bots.ml/API/YouTubeDl.php?search="..URL.escape(text))
...
local json = json:decode(http.request("https://sero-bots.ml/API/YouTubeDl.php?search="..URL.escape(search)..""))
...
{text = '‹ تحديثات السورس ›', url = 't.me/'..expsource..''}, 
},
}
}
