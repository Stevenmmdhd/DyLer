...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙تم رفعه نبي مسبقا ").Reply,"md",true)  
else
...
{
{text = 'لتنصيب بوت', url = 't.me/'..chdevolper..''},{text = 'مطور البوت', url = "t.me/"..UName_dev ''},
},
}
{text = '‹ DyLer TeAm ›', url = 't.me/'..chsource..''}, 
},
...
{
{text = '٠ قسم المطورين ٠',type = 'text'},{text = '٠ قسم الاشتراك ٠', type = 'text'},
},
{
{text = '٠ قسم الكلايش ٠',type = 'text'},{text = '٠ التفعيل والتعطيل ٠', type = 'text'},
},
{
...
{
{text = '٠ تفعيل المغادره ٠',type = 'text'},{text = '٠ تعطيل المغادره ٠',type = 'text'},
},
{
{text = '٠ رجوع ٠',type = 'text'},
},
