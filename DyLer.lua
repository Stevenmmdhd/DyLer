...
local m = "https://t.me/SSSS_ISS/"..Rrr..""
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مرة اخرى', callback_data=msg.sender.user_id.."/songg"},
},
}
local rep = msg.id/2097152/0.5
...
if text == "شعر" or text == "شع" then 
Abs = math.random(2,140); 
local Text ='*↯︙️تم اختيار الشعر لك*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- DyLer TeAm ٠',url="t.me/IIIIIIQ"}
