...
{
{text = '٠ قسم الكلايش ٠',type = 'text'},{text = '٠ السورس ٠', type = 'text'},
},
{
...
{text = '‹ مبرمج السورس ›', url = 't.me/'..chdevolper..''}, 
},
}
}
return send(msg_chat_id,msg_id,"‹ قناة السورس ومبرمج السورس ›","html",true, false, false, true, reply_markup)
end
