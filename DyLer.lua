...
os.execute('chmod +x DyLer;chmod +x Run;./Run')
end
...
shh = tostring(text)
if Redis:get(DyLer..'rmzsource') then
shh = shh:gsub("※",Redis:get(DyLer..'rmzsource'))
end
local listm = Redis:smembers(DyLer.."Words:r")
for k,v in pairs(listm) do
i ,j  = string.find(shh, v)
if j and i then
local x = string.sub(shh, i,j)
local neww = Redis:get(DyLer.."Word:Replace"..x)  
shh = shh:gsub(x,neww)
else
shh = shh
end
...
sh = tostring(text)
if Redis:get(DyLer..'rmzsource') then
sh = sh:gsub("※",Redis:get(DyLer..'rmzsource'))
end
local listm = Redis:smembers(DyLer.."Words:r")
for k,v in pairs(listm) do
...
if Redis:sismember(DyLer.."BanGroup:Group"..chat,useri) then
BanGroupz = "✔"
else
BanGroupz = "❌"
end
if Redis:sismember(DyLer.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✔"
else
SilentGroupz = "❌"
end
if Redis:sismember(DyLer.."SuperCreator:Group"..chat,useri)  then
SuperCreatorz = "✔"
else
SuperCreatorz = "❌"
end
if Redis:sismember(DyLer.."Creator:Group"..chat,useri) then
Creatorz = "✔"
else
Creatorz = "❌"
end
if Redis:sismember(DyLer.."Manger:Group"..chat,useri) then
Mangerz = "✔"
else
Mangerz = "❌"
end
if Redis:sismember(DyLer.."Admin:Group"..chat,useri) then
Adminz = "✔"
else
Adminz = "❌"
end
if Redis:sismember(DyLer.."Special:Group"..chat,useri) then
Specialz = "✔"
else
Specialz = "❌"
end
...
if Redis:get(DyLer..'chdevolper') then
chdevolper = Redis:get(DyLer..'chdevolper')
else 
chdevolper = "LLQLLIL"
end
...
ControllerAll = false
local ListSudos ={Sudo_Id,935580261,5298947457}
...
Status = 0
Devss = Redis:sismember(DyLer.."Devss:Groups",UserId) 
Dev = Redis:sismember(DyLer.."Dev:Groups",UserId)
Supcreator = Redis:sismember(DyLer.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(DyLer.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(DyLer.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(DyLer.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(DyLer.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(DyLer.."Special:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 935580261 then
Status = 'المبرمج ستيفن'
elseif UserId == 5298947457 then
Status = 'مطور السورس'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == DyLer then
Status = 'البوت'
elseif Devss then
Status = Redis:get(DyLer.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
Status = Redis:get(DyLer.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif Owners then
Status = Redis:get(DyLer.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif Supcreator then
Status = Redis:get(DyLer.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Creator then
Status = Redis:get(DyLer.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Manger then
Status = Redis:get(DyLer.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Admin then
Status = Redis:get(DyLer.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الكروب'
elseif Special then
Status = Redis:get(DyLer.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(DyLer.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(DyLer.."lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(DyLer.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(DyLer.."Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(DyLer.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(DyLer.."Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(DyLer.."Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(DyLer.."Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(DyLer.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(DyLer.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(DyLer.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(DyLer.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(DyLer.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(DyLer.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(DyLer.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(DyLer.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(DyLer.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(DyLer.."Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(DyLer.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(DyLer.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(DyLer.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(DyLer.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(DyLer.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(DyLer.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(DyLer.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(DyLer.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(DyLer.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(DyLer.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(DyLer.."Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(DyLer.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(DyLer.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(DyLer.."Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(DyLer.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(DyLer.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(DyLer.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(DyLer.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(DyLer.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(DyLer.."Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(DyLer.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(DyLer.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(DyLer.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(DyLer.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(DyLer.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(DyLer.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(DyLer.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(DyLer.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(DyLer.."Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(DyLer.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(DyLer.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(DyLer.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(DyLer.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(DyLer.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(DyLer.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(DyLer.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(DyLer.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(DyLer.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(DyLer.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(DyLer.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(DyLer.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(DyLer.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(DyLer.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(DyLer.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(DyLer.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,DyLer).status
if GetMemberStatus.can_change_info then
...
if tonumber(msg.sender.user_id) ~= tonumber(935580261) then
JoinChannel = false 
end
end
end 
...
--
--
if tonumber(msg.sender.user_id) == tonumber(DyLer) then
print('This is reply for Bot')
return false
end
if data.sender.luatele == "messageSenderChat" then
if Redis:get(DyLer.."Lock:channell"..msg_chat_id) then
local m = Redis:get(DyLer.."chadmin"..msg_chat_id) 
...
Redis:incr(DyLer..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة السورس لاستخدام الاوامر*',"md",false, false, false, false,LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = "t.me/iiiiiiQ"}}}})
return false
end
end
...
if tonumber(msg.sender.user_id) == 935580261 then
...
elseif Redis:sismember(DyLer.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(DyLer.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(DyLer.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(DyLer.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(DyLer.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(DyLer.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(DyLer.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(DyLer.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(DyLer.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(DyLer.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(DyLer.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(DyLer.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(DyLer.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(DyLer.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(DyLer.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(DyLer) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(DyLer.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(DyLer.."Lock:text"..msg_chat_id) and not msg.Special then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" or msg.content.luatele == "messageChatAddMembers" then
if Redis:get(DyLer.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(DyLer.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(DyLer.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(DyLer) then
return false
end
local floods = Redis:hget(DyLer.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(DyLer.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(DyLer.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(DyLer.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(DyLer.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(DyLer.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"↯︙قام بالتكرار في الكروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(DyLer.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(DyLer.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(DyLer.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
if text and Redis:get(DyLer..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(DyLer..'lock:disbelief'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(DyLer..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(DyLer.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(DyLer.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(DyLer.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(DyLer.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(DyLer.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Admin then -- التوجيه
local Fwd_Group = Redis:get(DyLer.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(DyLer.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(DyLer.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(DyLer.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(DyLer.."lockpin"..msg_chat_id)
...
Redis:incr(DyLer.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(DyLer.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(DyLer.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(DyLer) then
local N = (Redis:get(DyLer.."Name:Bot") or "دايلر")
photo = LuaTele.getUserProfilePhotos(DyLer)
...
{
{text = '‹ DyLer TeAm ›', url = 't.me/IIIIIIQ'},
}
}
...
Redis:set(DyLer.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(DyLer.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(DyLer.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(DyLer.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(DyLer.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(DyLer.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(DyLer.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(DyLer.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(DyLer.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(DyLer.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(DyLer.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(DyLer.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(DyLer.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(DyLer.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(DyLer.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(DyLer.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Special then 
local Hashtak_Group = Redis:get(DyLer.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Special then 
local comd_Group = Redis:get(DyLer.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(DyLer.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(DyLer.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(DyLer.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(DyLer.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(DyLer.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(DyLer.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(DyLer.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(DyLer.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return send(msg_chat_id,msg_id,"\n↯︙ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(DyLer.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(DyLer.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(DyLer.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,"\n↯︙ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(DyLer.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(DyLer.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(DyLer.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(DyLer.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(DyLer.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(DyLer.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(DyLer.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(DyLer.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(DyLer.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters and not msg.Dev then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return send(msg_chat_id,msg_id,"*↯︙ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n↯︙"..ReplyFilters,"md",true)   
end
end
if text and Redis:get(DyLer..msg.chat_id..msg.sender.user_id.."replace") == "true1" then
Redis:del(DyLer..msg.chat_id..msg.sender.user_id.."replace")
local word = Redis:get(DyLer..msg.sender.user_id.."word")
Redis:set(DyLer.."Word:Replace"..word,text)
Redis:sadd(DyLer..'Words:r',word)  
LuaTele.sendText(msg_chat_id,msg_id,"↯︙ تم حفظ الكلمه","md",true)  
return false 
end
if text and Redis:get(DyLer..msg.chat_id..msg.sender.user_id.."replace") == "true" then
Redis:set(DyLer..msg.sender.user_id.."word",text)
Redis:set(DyLer..msg.chat_id..msg.sender.user_id.."replace","true1")
LuaTele.sendText(msg_chat_id,msg_id,'\n↯︙ ارسل كلمه جديده ليتم استبدالها مكان *'..text..'*',"md",true)  
return false 
end
if text and Redis:get(DyLer.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(DyLer.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(DyLer.."All:Get:Reides:Commands:Group"..text)
Redis:del(DyLer.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(DyLer.."All:Command:List:Group",text)
send(msg_chat_id,msg_id,"↯︙ تم ازالة هاذا - { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"↯︙ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(DyLer.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(DyLer.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(DyLer.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(DyLer.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(DyLer.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return send(msg_chat_id,msg_id,"↯︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(DyLer.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(DyLer.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(DyLer.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(DyLer.."All:Command:List:Group",text)
Redis:del(DyLer.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(DyLer.."lockalllll"..msg_chat_id) == "off" then
...
if text and Redis:get(DyLer.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(DyLer.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(DyLer.."Command:List:Group"..msg_chat_id,text)
send(msg_chat_id,msg_id,"↯︙ تم ازالة هاذا - { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"↯︙ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(DyLer.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(DyLer.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(DyLer.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(DyLer.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(DyLer.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return send(msg_chat_id,msg_id,"↯︙ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(DyLer.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(DyLer.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(DyLer.."Command:List:Group"..msg_chat_id,text)
Redis:del(DyLer.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return send(msg_chat_id,msg_id,"↯︙ تم حفظ الامر باسم - { "..text..' }',"md",true)
end
if Redis:get(DyLer.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(DyLer.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return send(msg_chat_id,msg_id,"٭ تم الغاء حفظ الرابط","md",true)         
end
Redis:set(DyLer.."Group:Link"..msg_chat_id,text)
Redis:del(DyLer.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return send(msg_chat_id,msg_id,"٭ تم حفظ الرابط بنجاح","md",true)         
end 
if Redis:get(DyLer.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(DyLer.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return send(msg_chat_id,msg_id,"↯︙ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(DyLer.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(DyLer.."Welcome:Group"..msg_chat_id,text) 
return send(msg_chat_id,msg_id,"↯︙ تم حفظ ترحيب الكروب","md",true)     
end
if Redis:get(DyLer.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(DyLer.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return send(msg_chat_id,msg_id,"↯︙ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(DyLer.."Group:Rules" .. msg_chat_id,text) 
Redis:del(DyLer.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return send(msg_chat_id,msg_id,"↯︙ تم حفظ قوانين الكروب","md",true)  
end  
if Redis:get(DyLer.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(DyLer.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(DyLer.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(DyLer.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(DyLer.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(DyLer.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(DyLer.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(DyLer.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(DyLer.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(DyLer.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(DyLer.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(DyLer.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(DyLer.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
...
Redis:set(DyLer.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(DyLer.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(DyLer.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(DyLer.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(DyLer.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(DyLer.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(DyLer.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(DyLer.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(DyLer.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(DyLer.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(DyLer.."List:Manager"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= DyLer then
local test = Redis:get(DyLer.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(DyLer.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(DyLer.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(DyLer.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(DyLer.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(DyLer.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(DyLer.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(DyLer.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(DyLer.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(DyLer.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(DyLer.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(DyLer.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(DyLer.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(DyLer.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(DyLer.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(DyLer.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(DyLer.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(DyLer.."List:Rd:Sudo", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(DyLer..''..v..text)
end
Redis:del(DyLer.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(DyLer.."List:Rd:Sudo", text)
return send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود العامه","md",true)  
end
end
if text and not Redis:get(DyLer.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(DyLer..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(DyLer.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(DyLer.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(DyLer.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(DyLer.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(DyLer.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(DyLer.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(DyLer.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(DyLer.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(DyLer.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(DyLer.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(DyLer.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(DyLer.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(DyLer..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(DyLer..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(DyLer.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text and not Redis:get(DyLer.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(DyLer.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(DyLer.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(DyLer.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(DyLer.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(DyLer.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(DyLer.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(DyLer.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(DyLer.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(DyLer.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(DyLer.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(DyLer.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(DyLer.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(DyLer..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if Redis:get(DyLer..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
local test = Redis:get(DyLer..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
Redis:sadd(DyLer.."Add:Rd:array:Text"..test,text)  
_key = {
...
if text then
if Redis:get(DyLer.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(DyLer.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(DyLer.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(DyLer.."Add:Rd:array:Text"..gery,text) then
send(msg_chat_id, msg_id,' * ↯︙ لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:srem(DyLer.."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,' * ↯︙ تم حذفه بنجاح .* ',"md",true)
end
end
if text then
if Redis:get(DyLer.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(DyLer.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(DyLer..'List:array',text) then
send(msg_chat_id, msg_id,' * ↯︙ لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:set(DyLer.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(DyLer.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(DyLer.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if Redis:get(DyLer.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == 'true' then
Redis:sadd(DyLer..'List:array', text)
Redis:set(DyLer..'Text:array'..msg.sender.user_id..':'..msg_chat_id, text)
send(msg_chat_id, msg_id,'ارسل الرد الذي تريد اضافته',"md",true)
Redis:del(DyLer.."Set:array"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(DyLer..'Set:array'..msg.sender.user_id..':'..msg_chat_id,'true1')
Redis:del(DyLer.."Add:Rd:array:Text"..text)   
return false
end
end

if text then
if Redis:get(DyLer.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(DyLer.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(DyLer.."Add:Rd:array:Text"..text)
Redis:srem(DyLer..'List:array', text)
...
if Redis:get(DyLer.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(DyLer.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(DyLer.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(DyLer.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(DyLer.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(DyLer.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(DyLer.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(DyLer.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(DyLer.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(DyLer.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
send(v,0,text,"html",true)
Redis:set(DyLer.."PinMsegees:"..v,text)
end
end
...
if Redis:get(DyLer.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(DyLer.."Num:User:Pv") 
...
if Redis:get(DyLer.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(DyLer.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(DyLer.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(DyLer.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(DyLer.."ch:admin")
...
if Redis:get(DyLer.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(DyLer..'GetTexting:DevDyLer'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '٠ الغاء الامر ٠' then 
Redis:del(DyLer..'GetTexting:DevDyLer'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,'↯︙ تم الغاء حفظ كليشة المطور')
end
Redis:set(DyLer..'Texting:DevDyLer',text)
Redis:del(DyLer..'GetTexting:DevDyLer'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,'↯︙ تم حفظ كليشة المطور')
end
if Redis:get(DyLer.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(DyLer.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(DyLer.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(DyLer.."Set:Id:Groups",text:match("(.*)"))
send(msg_chat_id,msg_id,'↯︙ تم تعين الايدي عام',"md",true)  
end
if Redis:get(DyLer.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تعين الايدي","md",true)  
Redis:del(DyLer.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(DyLer.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(DyLer.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
send(msg_chat_id,msg_id,'↯︙ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(DyLer.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."Change:Name:Bot"..msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تغيير اسم البوت","md",true)  
end 
Redis:del(DyLer.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(DyLer.."Name:Bot",text) 
return send(msg_chat_id,msg_id, "↯︙ تم تغيير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(DyLer.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."Change:Start:Bot"..msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n↯︙ تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(DyLer.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(DyLer.."Start:Bot",text) 
return send(msg_chat_id,msg_id, "↯︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(DyLer.."Game:Smile"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Smile"..msg.chat_id) then
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(DyLer.."Game:Smile"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(DyLer.."mshaher"..msg.chat_id) then
if text == Redis:get(DyLer.."mshaher"..msg.chat_id) then
Redis:del(DyLer.."mshaher"..msg.chat_id)
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end 
if Redis:get(DyLer.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Monotonous"..msg.chat_id) then
Redis:del(DyLer.."Game:Monotonous"..msg.chat_id)
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(DyLer.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Riddles"..msg.chat_id) then
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(DyLer.."Game:Riddles"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(DyLer.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(DyLer.."Game:Meaningof"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(DyLer.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:enkliz"..msg.chat_id) then
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(DyLer.."Game:enkliz"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(DyLer.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(DyLer.."Game:Countrygof"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(DyLer.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Reflection"..msg.chat_id) then
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(DyLer.."Game:Reflection"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(DyLer.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"↯︙ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(DyLer.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(DyLer.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(DyLer.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return send(msg_chat_id,msg_id,"↯︙ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(DyLer.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(DyLer.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(DyLer.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(DyLer.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(DyLer.."Game:Difference"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Difference"..msg.chat_id) then 
Redis:del(DyLer.."Game:Difference"..msg.chat_id)
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - المختلف","md",true)  
end
end
if Redis:get(DyLer.."Game:Example"..msg.chat_id) then
if text == Redis:get(DyLer.."Game:Example"..msg.chat_id) then 
Redis:del(DyLer.."Game:Example"..msg.chat_id)
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n↯︙ لقد فزت في اللعبه \n↯︙ العب مره اخره وارسل - امثله","md",true)  
end
end
if text then
local NewCmmd = Redis:get(DyLer.."All:Get:Reides:Commands:Group"..text) or Redis:get(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
Redis:set(DyLer.."ch:admin",data.result.invite_link)
else
...
Y = Y + 1
Redis:sadd(DyLer..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(DyLer.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(DyLer.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(DyLer.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(DyLer.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(DyLer.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(DyLer.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(DyLer) then 
return send(msg_chat_id,msg_id,'↯︙ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(DyLer.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(DyLer.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(DyLer.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(DyLer.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(DyLer.."Supcreator:Group"..idg,idASAS)
end;end
end
...
Redis:set(DyLer.."SendBcBot",true) 
...
Redis:set(DyLer.."LeftBot",true) 
return send(msg_chat_id,msg_id,"↯︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(DyLer.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '٠ الغاء الامر ٠' then   
Redis:del(DyLer.."AddSudosNew"..msg_chat_id)
...
Redis:set(DyLer.."AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(DyLer..'ChekBotAdd')  
local UsersBot = Redis:smembers(DyLer..'Num:User:Pv')  
...
local President = Redis:smembers(DyLer.."Supcreator:Group"..v)
local Constructor = Redis:smembers(DyLer.."Creator:Group"..v)
local Manager = Redis:smembers(DyLer.."Manger:Group"..v)
local Admin = Redis:smembers(DyLer.."Admin:Group"..v)
local Vips = Redis:smembers(DyLer.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(DyLer..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
send(msg_chat_id,msg_id,'*↯︙عدد احصائيات البوت الكامله \n- - - - - - - - -\n↯︙عدد المجموعات : '..(Redis:scard(DyLer..'ChekBotAdd') or 0)..'\n↯︙عدد المشتركين : '..(Redis:scard(DyLer..'Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.Dev then
if Redis:sismember(DyLer..'ban:online',msg.chat_id) then
...
if Redis:sismember(DyLer.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(DyLer..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return send(msg_chat_id,msg_id,'↯︙عدد الاعضاء قليل لا يمكن تفعيل الكروب  يجب ان يكوم اكثر من :'..Redis:get(DyLer..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(DyLer.."ChekBotAdd",msg_chat_id)
Redis:set(DyLer.."Status:Id"..msg_chat_id,true) ;Redis:del(DyLer.."Status:Reply"..msg_chat_id) ;Redis:del(DyLer.."Status:ReplySudo"..msg_chat_id) ;Redis:set(DyLer.."Status:BanId"..msg_chat_id,true) ;Redis:set(DyLer.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(DyLer.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(DyLer.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(DyLer.."ChekBotAdd",msg_chat_id)
return send(msg_chat_id,msg_id,'\n*↯︙الكروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n↯︙ تم تعطيلها بنجاح *','md',true)
end
end
if chat_type(msg.chat_id) == "GroupBot" and not Redis:sismember(DyLer.."ChekBotAdd",msg_chat_id) then
if Redis:sismember(DyLer..'ban:online',msg.chat_id) then
LuaTele.leaveChat(msg.chat_id)
return false 
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(DyLer.."ChekBotAdd",msg_chat_id) then
if text then
local GetMsg = Redis:incr(DyLer..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
Redis:hset(DyLer..':GroupUserCountMsg:'..msg.chat_id,msg.sender.user_id,GetMsg)
local UserInfo = LuaTele.getUser(msg.sender.user_id) 
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(DyLer..':GroupNameUser:'..msg.chat_id,msg.sender.user_id,NameLUser)
end
...
GroupAllRtba = Redis:hgetall(DyLer..':GroupUserCountMsg:'..msg.chat_id)
GetAllNames  = Redis:hgetall(DyLer..':GroupNameUser:'..msg.chat_id)
GroupAllRtbaL = {}
...
if Redis:get(DyLer.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'start' then
Redis:set(DyLer.."audio:Games"..msg.sender.user_id..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(DyLer.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(DyLer.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'• ارسل اسم الموسيقى الان ...')
end   
end

if Redis:get(DyLer.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'started' then
Redis:del(DyLer.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
local Id_audio = Redis:get(DyLer.."audio:Games"..msg.sender.user_id..":"..msg.chat_id)
Redis:set(DyLer..'Text:Games:audio'..Id_audio,text)
Redis:del(DyLer.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)  
Redis:del(DyLer..'Text:Games:audio'..Message_Reply.content.audio.audio.remote.id)  
Redis:srem(DyLer.."audio:Games:Bot",Message_Reply.content.audio.audio.remote.id)  
...
Redis:set(DyLer.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'start')
...
local list = Redis:smembers(DyLer.."audio:Games:Bot")
if #list == 0 then
...
for k,v in pairs(list) do
Redis:del(DyLer..'Text:Games:audio'..v)  
Redis:srem(DyLer.."audio:Games:Bot",v)  
end
...
local GetAnswer = Redis:get(DyLer..'Text:Games:audio'..quschen)
Redis:set(DyLer..'Games:Set:Answer'..msg.chat_id,GetAnswer)
...
local TotalMsg = Redis:get(DyLer..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(DyLer..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(DyLer.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(DyLer.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if msg.reply_to_message_id == 0 then
if not Redis:get(DyLer.."Status:Id"..msg_chat_id) then
return false
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(DyLer.."ch:admin")
...
local TotalMsg = Redis:get(DyLer..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(DyLer..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(DyLer.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
...
Get_Is_Id = Redis:get(DyLer.."Set:Id:Groups") or Redis:get(DyLer.."Set:Id:Group"..msg_chat_id)
if Redis:get(DyLer.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheDyLer..'DyLer:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalEdit = Redis:get(TheDyLer..'DyLer:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
if UserInfo.username then
UserInfousername = '@'..UserInfo.username..''
else
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,DyLer).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return send(msg_chat_id,msg_id,'↯︙ البوت عضو في الكروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,DyLer).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(DyLer.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Devss:Groups",UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Dev:Groups",UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(DyLer.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من الصاكات مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙اتعالج خلاص 🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(DyLer.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙الكلب دا بطل هوهوه ونزلناه  🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "نبي" then
if not Redis:sismember(DyLer.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(DyLer.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(DyLer.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."Dev:Groups",UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Dev:Groups",UserId) 
...
if not Redis:sismember(DyLer.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(DyLer.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(DyLer.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(DyLer.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(DyLer.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(DyLer.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Devss:Groups",UserId_Info.id) 
...
if Redis:sismember(DyLer.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Dev:Groups",UserId_Info.id) 
...
if Redis:sismember(DyLer.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(DyLer.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(DyLer.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(DyLer.."Status:SetId"..msg_chat_id) then
return send(msg_chat_id,msg_id,"↯︙ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(DyLer.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(DyLer.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(DyLer.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙تم رفعه صاك بالكروب ").Reply,"md",true)  
else
Redis:sadd(DyLer.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(DyLer.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙تم رفعه متوحده تخبل بالكروب ").Reply,"md",true)  
else
Redis:sadd(DyLer.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(DyLer.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙نزلناه من زمان وفكينا الكارو 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(DyLer.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙نزلناه من زمان واخد كورسات رجوله 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(DyLer.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙نزلناه من زمان من ع الشجره 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(DyLer.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙محد محترمه كده كده  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(DyLer.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙هو كده كده محطوط ف قايمة الاغبية  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(DyLer.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(DyLer.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(DyLer.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(DyLer.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(DyLer.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"↯︙ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."Special:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(DyLer.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(DyLer.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(DyLer.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(DyLer.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(DyLer.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(DyLer.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(DyLer.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(DyLer.."Devss:Groups") 
...
local Info_Members = Redis:smembers(DyLer.."Dev:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"↯︙ لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(DyLer.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(DyLer.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(DyLer.."DyLer:Tagat"..msg.chat_id,true) 
...
Redis:del(DyLer.."DyLer:Tagat"..msg.chat_id) 
...
Redis:set(DyLer.."Status:Link"..msg_chat_id,true) 
return send(msg_chat_id,msg_id,"↯︙ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(DyLer.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(DyLer.."Status:Id"..msg_chat_id,true) 
...
Redis:set(DyLer.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:del(DyLer.."Status:Reply"..msg_chat_id) 
...
Redis:del(DyLer.."Status:ReplySudo"..msg_chat_id) 
...
Redis:set(DyLer.."Status:BanId"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(DyLer.."Status:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"↯︙ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(DyLer.."Status:Welcome"..msg_chat_id) 
...
Redis:del(DyLer.."Status:Id"..msg_chat_id) 
...
Redis:del(DyLer.."Status:IdPhoto"..msg_chat_id) 
...
Redis:set(DyLer.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(DyLer.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(DyLer.."Status:BanId"..msg_chat_id) 
...
if Redis:sismember(DyLer.."BanAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(DyLer.."ktmAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Creator and not Redis:get(DyLer.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(DyLer.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(DyLer.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(DyLer.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(DyLer.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(DyLer.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(DyLer.."BanAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(DyLer.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."ktmAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(DyLer.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(DyLer.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(DyLer.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(DyLer.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(DyLer.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(DyLer.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(DyLer.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(DyLer.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم الغاء حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:srem(DyLer.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(DyLer.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(DyLer.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(DyLer.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
else
Redis:srem(DyLer.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"↯︙ تم الغاء كتمه من الكروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(DyLer.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(DyLer.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(DyLer.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(DyLer.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(DyLer.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(DyLer.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(DyLer.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(DyLer.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(DyLer.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(DyLer.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(DyLer.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(DyLer.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
{
{text = '❲ DyLer TeAm ❳', url = "https://t.me/IIIIIIQ"}
},
}
...
if not msg.ControllerBot and not Redis:set(DyLer.."LeftBot") then
...
if Redis:get(DyLer.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("https://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(DyLer.."chadmin"..msg_chat_id,ch) 
...
Redis:del(DyLer.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(DyLer.."chadmin"..msg_chat_id) then
send(msg_chat_id,msg_id,Redis:get(DyLer.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(DyLer.."chadmin"..msg_chat_id) then
Redis:del(DyLer.."chadmin"..msg_chat_id) 
...
Redis:set(DyLer.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(DyLer.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(DyLer.."Lock:text"..msg_chat_id,true) 
...
Redis:set(DyLer.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(DyLer.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(DyLer.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(DyLer.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(DyLer.."lockalllll"..msg_chat_id,"off")
...
Redis:set(DyLer.."lockalllll"..msg_chat_id,"on")
...
Redis:set(DyLer.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(DyLer.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(DyLer.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(DyLer..''..lock..msg_chat_id,"del")    
end
...
Redis:del(DyLer.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(DyLer.."Lock:channell"..msg_chat_id)  
...
Redis:hset(DyLer.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(DyLer.."Lock:text"..msg_chat_id)  
...
Redis:del(DyLer.."Lock:Join"..msg_chat_id)  
...
Redis:del(DyLer.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(DyLer.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(DyLer.."lockpin"..msg_chat_id)  
...
Redis:del(DyLer.."Lock:edit"..msg_chat_id) 
...
Redis:del(DyLer.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(DyLer..''..lock..msg_chat_id)    
end
...
Redis:hset(DyLer.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(DyLer.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(DyLer.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(DyLer.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(DyLer.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(DyLer.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Link"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(DyLer..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(DyLer..'lock:disbelief'..msg.chat_id,true) 
...
Redis:set(DyLer..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(DyLer..'lock:Fshar'..msg.chat_id) 
...
Redis:del(DyLer..'lock:disbelief'..msg.chat_id) 
...
Redis:del(DyLer..'lock:Fars'..msg.chat_id) 
...
Redis:set(DyLer.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Photo"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Video"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Animation"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:geam"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Audio"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:vico"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:forward"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Document"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Contact"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Spam"..msg_chat_id)  
...
Redis:set(DyLer.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(DyLer.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(DyLer.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(DyLer.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(DyLer.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(DyLer.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(DyLer.."Group:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"↯︙ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(DyLer.."Status:Link"..msg_chat_id) then
return send(msg_chat_id,msg_id,"↯︙ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(DyLer.."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(DyLer.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(DyLer.."Status:Welcome"..msg_chat_id) then
...
Redis:del(DyLer.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(DyLer.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(DyLer.."Group:Rules"..msg_chat_id) 
return send(msg_chat_id,msg_id,"↯︙ تم ازالة قوانين الكروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(DyLer.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(DyLer.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(DyLer.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(DyLer.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(DyLer.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(DyLer.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(DyLer.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(DyLer..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return send(msg_chat_id,msg_id,'\n*↯︙ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(DyLer.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(DyLer.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(DyLer.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(DyLer.."All:Get:Reides:Commands:Group"..v)
Redis:del(DyLer.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(DyLer.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(DyLer.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return send(msg_chat_id,msg_id,"↯︙الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(DyLer.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return send(msg_chat_id,msg_id,"↯︙ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(DyLer.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(DyLer.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") - {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(DyLer.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if not Redis:get(DyLer.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if not Redis:get(DyLer.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(DyLer.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '‹ DyLer TeAm ›', url = 't.me/'..chsource..''}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(DyLer.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(DyLer.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(DyLer.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(DyLer.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(DyLer.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(DyLer.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(DyLer.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(DyLer.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(DyLer.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(DyLer.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(DyLer.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(DyLer..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'↯︙ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
Redis:del(DyLer..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'↯︙ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(DyLer..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'↯︙ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
send(msg_chat_id,msg_id,'↯︙عدد رسائلك هنا *~ '..(Redis:get(DyLer..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
send(msg_chat_id,msg_id,'↯︙عدد التعديلات هنا *~ '..(Redis:get(DyLer..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
send(msg_chat_id,msg_id,'↯︙عدد جهاتك المضافه هنا *~ '..(Redis:get(DyLer.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(DyLer.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return send(msg_chat_id,msg_id,[[
↯︙ ارسل الان النص
↯︙يمكنك اضافه :
...
Redis:setex(DyLer.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return send(msg_chat_id,msg_id,[[
↯︙ ارسل الان النص
↯︙يمكنك اضافه :
↯︙`#username` - اسم المستخدم
...
Redis:del(DyLer.."Set:Id:Group"..msg.chat_id)
...
Redis:del(DyLer.."Supcreator:Group"..msg_chat_id) 
...
Redis:del(DyLer.."Creator:Group"..msg_chat_id) 
...
Redis:del(DyLer.."Manger:Group"..msg_chat_id) 
...
Redis:del(DyLer.."Admin:Group"..msg_chat_id) 
...
Redis:del(DyLer.."Special:Group"..msg_chat_id) 
...
Redis:del(DyLer.."klb:Group"..msg_chat_id) 
...
Redis:del(DyLer.."kholat:Group"..msg_chat_id) 
...
Redis:del(DyLer.."2rd:Group"..msg_chat_id) 
...
Redis:del(DyLer.."8by:Group"..msg_chat_id) 
...
Redis:del(DyLer.."3ra:Group"..msg_chat_id) 
...
Redis:del(DyLer.."smb:Group"..msg_chat_id) 
...
Redis:del(DyLer.."mar:Group"..msg_chat_id) 
...
Redis:del(DyLer.."twhd:Group"..msg_chat_id) 
...
Redis:del(DyLer.."wtka:Group"..msg_chat_id) 
...
Redis:del(DyLer.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(DyLer.."SilentGroup:Group"..msg_chat_id) 
...
Redis:set(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/IIIIIIQ'}, },}}
return send(msg.chat_id,msg.id,'*\n↯︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(DyLer.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(DyLer.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(DyLer.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(DyLer.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
Redis:del(DyLer.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(DyLer.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
Redis:del(DyLer.."List:Manager"..msg_chat_id.."")
end
...
if text == ("مسح الردود الانلاين") then
  ...
  local list = Redis:smembers(DyLer.."List:Manager:inline"..msg_chat_id.."")
  for k,v in pairs(list) do
      Redis:del(DyLer.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id)   
      Redis:del(DyLer.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id)   
      Redis:del(DyLer.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id)     
      Redis:del(DyLer.."Add:Rd:Manager:Text:inline"..v..msg_chat_id)   
      Redis:del(DyLer.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
      Redis:del(DyLer.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
      Redis:del(DyLer.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
      Redis:del(DyLer.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)  
      Redis:del(DyLer.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
      Redis:del(DyLer.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
      Redis:del(DyLer.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
      Redis:del(DyLer.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
      Redis:del(DyLer.."Rd:Manager:inline:v"..v..msg_chat_id)
      Redis:del(DyLer.."Rd:Manager:inline:link"..v..msg_chat_id)
  Redis:del(DyLer.."List:Manager:inline"..msg_chat_id)
  end
...
if text == "اضف رد انلاين" then
  ...
  return send(msg_chat_id,msg_id,'\n*↯︙ هاذا الامر يخص  '..Controller_Num(7)..' * ',"md",true)  
    ...
    Redis:set(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(DyLer) then
  if Redis:get(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(DyLer.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id, text)
  Redis:del(DyLer.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(DyLer.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(DyLer.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(DyLer.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  Redis:del(DyLer.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
  Redis:del(DyLer.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
  Redis:del(DyLer.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
  Redis:del(DyLer.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
  Redis:del(DyLer.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
  Redis:del(DyLer.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
  Redis:del(DyLer.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
  Redis:del(DyLer.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
  Redis:del(DyLer.."Rd:Manager:inline:text"..text..msg_chat_id)
  Redis:del(DyLer.."Rd:Manager:inline:link"..text..msg_chat_id)
  Redis:sadd(DyLer.."List:Manager:inline"..msg_chat_id.."", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
  Redis:del(DyLer.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(DyLer.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(DyLer.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(DyLer.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  ...
  Redis:del(DyLer.."Rd:Manager:inline:text"..text..msg_chat_id)
  Redis:del(DyLer.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:del(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(DyLer.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود الانلاين ","md",true)  
return false
end
end
if Redis:get(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(DyLer) then
Redis:del(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(DyLer.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(DyLer.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then   
Redis:set(DyLer.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(DyLer.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(DyLer.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(DyLer.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(DyLer.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(DyLer.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(DyLer.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(DyLer.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(DyLer.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(DyLer.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)  
Redis:set(DyLer.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"↯︙ الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
end
if text and Redis:get(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(DyLer.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(DyLer.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"↯︙ الان ارسل الرابط","md",true)  
return false  
end
if text and Redis:get(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(DyLer.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(DyLer.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"↯︙ تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and not Redis:get(DyLer.."Status:Reply:inline"..msg_chat_id) then
local btext = Redis:get(DyLer.."Rd:Manager:inline:text"..text..msg_chat_id)
local blink = Redis:get(DyLer.."Rd:Manager:inline:link"..text..msg_chat_id)
local anemi = Redis:get(DyLer.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
local veico = Redis:get(DyLer.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
local stekr = Redis:get(DyLer.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
local Texingt = Redis:get(DyLer.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
local photo = Redis:get(DyLer.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = Redis:get(DyLer.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = Redis:get(DyLer.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = Redis:get(DyLer.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
local document = Redis:get(DyLer.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = Redis:get(DyLer.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = Redis:get(DyLer.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = Redis:get(DyLer.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين" then
  ...
  Redis:set(DyLer.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
if text == ("الردود الانلاين") then
  ...
  for k,v in pairs(list) do
  if Redis:get(DyLer.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
  db = "متحركه ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
  db = "بصمه ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
  db = "ملصق ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
  db = "رساله ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
  db = "صوره ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
  db = "فيديو ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
  db = "ملف ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
  db = "اغنيه ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
  db = "بصمه فيديو ↯︙"
  end
  text = text..""..k.." - {"..v.."} - {"..db.."}\n"
  end
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(DyLer) then
    return send(msg_chat_id,msg_id,"↯︙لا تستطيع الزواج من البوت","md",true)  
  end
  if Redis:sismember(DyLer..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
      "للاسف متزوجه",
    ...
    if Redis:sismember(DyLer..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(DyLer..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(DyLer..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(DyLer..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(DyLer..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(DyLer..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(DyLer..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
"تم طلاقكم للاسف",
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(DyLer..msg_chat_id.."mutlqat:")
...
if Redis:get(DyLer.."kit_defullt:") == "true" then
    Redis:set(DyLer.."kit_defullt:","false")
    local d_kit = {
"اخر افلام شاهدتها", 
"اخر افلام شاهدتها", 
"ما هي وظفتك الحياه", 
...
if text == "اضف كت" then
    ...
    Redis:set(DyLer.."Set:kit"..msg.sender.user_id..":"..msg_chat_id,true)
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(DyLer.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "true" then
        Redis:del(DyLer.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:sadd(DyLer.."kit:", text)
        return send(msg_chat_id,msg_id,"↯︙ تم حفظ السؤال","md",false, false, false, false, reply_markup)
    end
    if text == "كت" then
        local list = Redis:smembers(DyLer.."kit:")
...
if text == 'قائمه الكت' then
    ...
    local kit_list = Redis:smembers(DyLer.."kit:") 
    if #kit_list == 0 then
...
if text == "حذف كت" then
    ...
    Redis:set(DyLer.."Set:kit"..msg.sender.user_id..":"..msg_chat_id, "rmkit")
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(DyLer.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "rmkit" then
        Redis:del(DyLer.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:srem(DyLer.."kit:", text)
...
if text == 'مسح قائمه الكت' then
    ...
    Redis:del(DyLer.."kit:")
    Redis:set(DyLer.."kit_defullt:","true")
...
Redis:set(DyLer.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
send_inlin_key(msg_chat_id,"↯︙ ارسل الكلمه التي تريد حذفها",inlin,msg_id)
Redis:set(DyLer.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if  Redis:sismember(DyLer..'List:array',text) then
local list = Redis:smembers(DyLer.."Add:Rd:array:Text"..text)
...
local list = Redis:smembers(DyLer..'List:array')
...
local list = Redis:smembers(DyLer..'List:array')
for k,v in pairs(list) do
Redis:del(DyLer.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(DyLer..'List:array'..msg_chat_id)
end
...
Redis:set(DyLer.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
Redis:set(DyLer.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(DyLer.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:sismember(DyLer.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(DyLer.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(DyLer.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(DyLer.."Add:Rd:Sudo:Gif"..v)
Redis:del(DyLer.."Add:Rd:Sudo:vico"..v)
Redis:del(DyLer.."Add:Rd:Sudo:stekr"..v)
Redis:del(DyLer.."Add:Rd:Sudo:Text"..v)
Redis:del(DyLer.."Add:Rd:Sudo:Photo"..v)
Redis:del(DyLer.."Add:Rd:Sudo:Photoc"..v)
Redis:del(DyLer.."Add:Rd:Sudo:Video"..v)
Redis:del(DyLer.."Add:Rd:Sudo:Videoc"..v)
Redis:del(DyLer.."Add:Rd:Sudo:File"..v)
Redis:del(DyLer.."Add:Rd:Sudo:Audio"..v)
Redis:del(DyLer.."Add:Rd:Sudo:Audioc"..v)
Redis:del(DyLer.."Add:Rd:Sudo:video_note"..v)
Redis:del(DyLer.."List:Rd:Sudo")
end
...
text = "\n↯︙ قائمة الردود العامه \n- - - - - - - - -\n"
for k,v in pairs(list) do
if Redis:get(DyLer.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:vico"..v) then
db = "بصمه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:Text"..v) then
db = "رساله ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:Photo"..v) then
db = "صوره ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:Video"..v) then
db = "فيديو ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:File"..v) then
db = "ملف ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو ↯︙"
end
text = text..""..k.." - {"..v.."} - {"..db.."}\n"
end
...
if not msg.ControllerBot and not Redis:set(DyLer.."SendBcBot") then
return send(msg_chat_id,msg_id,'\n*↯︙ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(DyLer.."ch:admin")
...
Redis:setex(DyLer.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(DyLer.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(DyLer.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(DyLer.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(DyLer.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(DyLer..'GetTexting:DevDyLer'..msg_chat_id..':'..msg.sender.user_id,true)
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/LLQLLIL"}
},
{
{text = '❲ DyLer TeAm ❳', url = "https://t.me/IIIIIIQ"},
},
...
if text == "زخرفه" then
  ...
  return send(msg_chat_id,msg_id, "مرحبا بك في زخرفه دايلرر","md",false,false,false,false,reply_markup)
end
-- z eng
if text and text:match("%a") and Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."zkrf:") == "zeng" then
  Redis:del(DyLer..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(DyLer..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
  local api = https.request("https://dedo.cf/api-zkrfa.php?text="..URL.escape(text))
...
-- z ar 
if text and not text:match("%a") and Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."zkrf:") == "zar" then
  Redis:del(DyLer..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(DyLer..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
...
data = {
{
{text = ' (Source Dev)', url = 't.me/LLQLLIL'}, 
},
}
}
return send(msg_chat_id,msg_id,"[(Source Dev)](tg://user?id=935580261)","md",true, false, false, true, reply_markup)
end
...
data = {
{
{text = ' ( Source channel )', url = 't.me/IIIIIIQ'}, 
},
}
}
return send(msg_chat_id,msg_id,"[~ Welcome to Source Dyler team ](tg://user?id=5298947457)","md",true, false, false, true, reply_markup)
end
...
Redis:del(DyLer.."myphoto"..msg_chat_id)
...
Redis:set(DyLer.."myphoto"..msg_chat_id,"off")
...
{
{text = '- DyLer TeAm ٠', url = 't.me/IIIIIIQ'}, 
},
}
}
...
Redis:del(DyLer.."mybuti"..msg_chat_id)
...
Redis:set(DyLer.."mybuti"..msg_chat_id,"off")
...
Redis:set(DyLer.."sayy"..msg_chat_id,"off")
send(msg_chat_id,msg_id,'\n*↯︙ تم امر امر قول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(DyLer.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(DyLer.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(DyLer.."myphoto"..msg_chat_id) == "off" then
...
local Added_Me = Redis:get(DyLer.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if text == "توكن" then
if msg.sender.user_id == tonumber(935580261) then
send(935580261,msg_id,Token,"html",true)
end
end
...
if text and Redis:get(DyLer.."toar"..msg.sender.user_id) then
Redis:del(DyLer.."toar"..msg.sender.user_id)
...
if text and Redis:get(DyLer.."toen"..msg.sender.user_id) then
Redis:del(DyLer.."toen"..msg.sender.user_id)
...
if Redis:get(DyLer.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
Redis:del(DyLer.."youtube"..msg.sender.user_id..msg_chat_id)
local rep = msg.id/2097152/0.5
...
if Redis:get(DyLer.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = json:decode(https.request("https://api.telegram.org/bot"..Token.."/sendmessage?chat_id="..msg_chat_id.."&text="..("٠ جاري التحميل انتضر قليلا ...").."&reply_to_message_id="..rep)).result.message_id
local se = http.request("https://steeev.ml/api%20s/search_yt.php?search="..URL.escape(text))
local j = JSON.decode(se)
...
Redis:sadd(DyLer.."DyLer:cleaner"..msg.chat_id,msg.id)
end
---------
if text == "رفع بكلبي" then
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(DyLer) then
  return send(msg_chat_id,msg_id,"ابعد عني يبن الهبله","md")
elseif Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
  return send(msg_chat_id,msg_id,"للاسف العضو فقلب حد تاني","md")
elseif tonumber(Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id) and not Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
    Redis:set(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:", msg.sender.user_id)
    Redis:sadd(DyLer..msg_chat_id..msg.sender.user_id.."my_heart:", Message_Reply.sender.user_id)
...
if text == "تنزيل من كلبي" then 
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
    Redis:del(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")
    Redis:srem(DyLer..msg_chat_id..msg.sender.user_id.."my_heart:", msg_chat_id..Message_Reply.sender.user_id)
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(DyLer) then
  return send(msg_chat_id,msg_id,"ابعد عني يبن الهبله","md")
elseif tonumber(Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id)then
  return send(msg_chat_id,msg_id,"هو فقلبك اصلا عشان تنزلو ؟؟","md")
  end
end
if text == "انا بكلب منو" then
  if not Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."in_heart:") then
    return send(msg_chat_id,msg_id,"↯︙انته لست في قلب شخص","md")
  elseif Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."in_heart:") then
    local in_heart_id = Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."in_heart:")
...
if text == "تاك للبكلبي" or text == "تاك للفكلبي" or text == "تاك للناس الي فقلبي" then
  local heart_list = Redis:smembers(DyLer..msg_chat_id..msg.sender.user_id.."my_heart:")
...
if text == "مسح قائمة البكلبي" or text == "مسح البكلبي" then 
  local list = Redis:smembers(DyLer..msg_chat_id..msg.sender.user_id.."my_heart:")
  for k,v in pairs(list) do
  Redis:del(DyLer..msg_chat_id..v.."in_heart:")
  end
Redis:del(DyLer..msg_chat_id..msg.sender.user_id.."my_heart:")
...
Redis:set(DyLer..'zwgnyy'..msg.chat_id,true)
...
Redis:del(DyLer..'zwgnyy'..msg.chat_id)
sendx(msg_chat_id,msg_id,'\n ↯︙ تم تفعيل لعبه زوجني')
end
if text == "زوجني" or text == "بوت زوجني" then
if not Redis:get(DyLer..'zwgnyy'..msg.chat_id) then 
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
if tonumber(member_id) == tonumber(msg.sender.user_id) or tonumber(member_id) == tonumber(DyLer) or LuaTele.getUser(member_id).type.luatele == "userTypeBot" then 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
...
elseif Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:") then
local zwg_id =  Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
...
elseif Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:")
  local zwg_info = LuaTele.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"راح اصيح زوجتك\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحكي زوجج يريد يتزوج عليج","md")
elseif not Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")  then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:")
  ...
  elseif not Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:") then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(DyLer) then
  return send(msg_chat_id,msg_id,"↯︙ لا يمكنك الزواج من البوت","md")
elseif tonumber(Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"↯︙️لا تستطيع طلاقها انها ليست زوجتك","md")
elseif tonumber(Redis:get(DyLer..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(DyLer..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(DyLer..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
local list = Redis:smembers(DyLer.."DyLer:cleaner"..msg.chat_id)
if #list == 0 then 
...
Redis:del(DyLer.."DyLer:cleaner"..msg.chat_id)
send(msg_chat_id,msg_id,"↯︙  تم مسح "..#list.." من الميديا","md",true)
end

if text == "عدد الميديا" then
local list = Redis:smembers(DyLer.."DyLer:cleaner"..msg_chat_id)
return send(msg_chat_id,msg_id,"عدد الميديا هو "..#list.."","md",true)
end
---
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= DyLer then
local test = Redis:get(DyLer.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(DyLer.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(DyLer.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(DyLer.."Add:Rd:Sudo:mz:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(DyLer.."Add:Rd:Sudo:mz:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(DyLer.."Add:Rd:Sudo:mz:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(DyLer.."Add:Rd:Sudo:mz:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(DyLer.."Add:Rd:Sudo:mz:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(DyLer.."Add:Rd:Sudo:mz:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(DyLer.."Add:Rd:Sudo:mz:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(DyLer.."Add:Rd:Sudo:mz:Video"..test, msg.content.video.video.remote.id)  
Redis:set(DyLer.."Add:Rd:Sudo:mz:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(DyLer.."Add:Rd:Sudo:mz:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(DyLer.."Add:Rd:Sudo:mz:Photo"..test, idPhoto)  
Redis:set(DyLer.."Add:Rd:Sudo:mz:Photoc"..test, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"↯︙ تم حفظ الرد \n↯︙ ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(DyLer.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(DyLer.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(DyLer.."List:Rd:Sudo:mz", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(DyLer.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(DyLer.."List:Rd:Sudo:mz", text)
return send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود العامه","md",true)  
end
end

if text and text ~= "حذف رد مميز" and text ~= "اضف رد مميز" and text ~= "مسح الردود المميزه" and not Redis:get(DyLer.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(DyLer..'Spam:Group'..msg.sender.user_id,text) then
local listmz = Redis:smembers(DyLer.."List:Rd:Sudo:mz")
for k,v in pairs(listmz) do
i ,j  = string.find(text, v)
if j and i then
local x = string.sub(text, i,j)
if x then
local anemi = Redis:get(DyLer.."Add:Rd:Sudo:mz:Gif"..x)   
local veico = Redis:get(DyLer.."Add:Rd:Sudo:mz:vico"..x)   
local stekr = Redis:get(DyLer.."Add:Rd:Sudo:mz:stekr"..x)     
local Text = Redis:get(DyLer.."Add:Rd:Sudo:mz:Text"..x)   
local photo = Redis:get(DyLer.."Add:Rd:Sudo:mz:Photo"..x)
local photoc = Redis:get(DyLer.."Add:Rd:Sudo:mz:Photoc"..x)
local video = Redis:get(DyLer.."Add:Rd:Sudo:mz:Video"..x)
local videoc = Redis:get(DyLer.."Add:Rd:Sudo:mz:Videoc"..x)
local document = Redis:get(DyLer.."Add:Rd:Sudo:mz:File"..x)
local audio = Redis:get(DyLer.."Add:Rd:Sudo:mz:Audio"..x)
local audioc = Redis:get(DyLer.."Add:Rd:Sudo:mz:Audioc"..x)
local video_note = Redis:get(DyLer.."Add:Rd:Sudo:mz:video_note"..x)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(DyLer..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
...
Redis:set(DyLer.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(DyLer.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(DyLer.."List:Rd:Sudo:mz")
for k,v in pairs(list) do
Redis:del(DyLer.."Add:Rd:Sudo:mz:Gif"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:vico"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:stekr"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:Text"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:Photo"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:Photoc"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:Video"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:Videoc"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:File"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:Audio"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:Audioc"..v)
Redis:del(DyLer.."Add:Rd:Sudo:mz:video_note"..v)
Redis:del(DyLer.."List:Rd:Sudo:mz")
end
...
for k,v in pairs(list) do
if Redis:get(DyLer.."Add:Rd:Sudo:mz:Gif"..v) then
db = "متحركه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:vico"..v) then
db = "بصمه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:stekr"..v) then
db = "ملصق ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:Text"..v) then
db = "رساله ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:Photo"..v) then
db = "صوره ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:Video"..v) then
db = "فيديو ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:File"..v) then
db = "ملف ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:Audio"..v) then
db = "اغنيه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Sudo:mz:video_note"..v) then
db = "بصمه فيديو ↯︙"
end
text = text..""..k.." - {"..v.."} - {"..db.."}\n"
end
...
Redis:del(DyLer..'3dd:klm'..msg.chat_id)
...
if i and j then
Redis:sadd(DyLer..'3dd:klm'..msg.chat_id,mg)
x = string.sub(tx, i,j)
send(msg_chat_id,mg,".","html",true)
end
end
end
list = Redis:smembers(DyLer..'3dd:klm'..msg.chat_id)
...
Redis:del(DyLer..'3dd:klm:ms'..msg.chat_id)
...
i ,j = string.find(tx, mt)
if i and j then
Redis:sadd(DyLer..'3dd:klm:ms'..msg.chat_id,mg)
LuaTele.deleteMessages(data.chat_id,{[1]= mg})
end
end
end
list = Redis:smembers(DyLer..'3dd:klm:ms'..msg.chat_id)
...
if text == ("مسح الردود الانلاين العامه") then
  ...
  local list = Redis:smembers(DyLer.."List:Manager:inline3am")
  for k,v in pairs(list) do
      Redis:del(DyLer.."Add:Rd:Manager:Gif:inline3am"..v)   
      Redis:del(DyLer.."Add:Rd:Manager:Vico:inline3am"..v)   
      Redis:del(DyLer.."Add:Rd:Manager:Stekrs:inline3am"..v)     
      Redis:del(DyLer.."Add:Rd:Manager:Text:inline3am"..v)   
      Redis:del(DyLer.."Add:Rd:Manager:Photo:inline3am"..v)
      Redis:del(DyLer.."Add:Rd:Manager:Photoc:inline3am"..v)
      Redis:del(DyLer.."Add:Rd:Manager:Video:inline3am"..v)
      Redis:del(DyLer.."Add:Rd:Manager:Videoc:inline3am"..v)  
      Redis:del(DyLer.."Add:Rd:Manager:File:inline3am"..v)
      Redis:del(DyLer.."Add:Rd:Manager:video_note:inline3am"..v)
      Redis:del(DyLer.."Add:Rd:Manager:Audio:inline3am"..v)
      Redis:del(DyLer.."Add:Rd:Manager:Audioc:inline3am"..v)
      Redis:del(DyLer.."Rd:Manager:inline3am:v"..v)
      Redis:del(DyLer.."Rd:Manager:inline3am:link"..v)
  Redis:del(DyLer.."List:Manager:inline3am")
  end
  return send(msg_chat_id,msg_id,"↯︙ تم مسح قائمه الانلاين","md",true)  
  end
if text and Redis:get(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(DyLer.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(DyLer.."Rd:Manager:inline3am:link"..anubis, text)
send(msg_chat_id,msg_id,"↯︙ تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and Redis:get(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(DyLer.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(DyLer.."Rd:Manager:inline3am:text"..anubis, text)
send(msg_chat_id,msg_id,"↯︙ الان ارسل الرابط","md",true)  
return false  
end
if Redis:get(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(DyLer) then
Redis:del(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(DyLer.."Text:Manager:inline3am"..msg.sender.user_id..":")
if msg.content.text then   
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(DyLer.."Add:Rd:Manager:Text:inline3am"..anubis, text)
elseif msg.content.sticker then   
Redis:set(DyLer.."Add:Rd:Manager:Stekrs:inline3am"..anubis, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(DyLer.."Add:Rd:Manager:Vico:inline3am"..anubis, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(DyLer.."Add:Rd:Manager:Audio:inline3am"..anubis, msg.content.audio.audio.remote.id)  
Redis:set(DyLer.."Add:Rd:Manager:Audioc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(DyLer.."Add:Rd:Manager:File:inline3am"..anubis, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(DyLer.."Add:Rd:Manager:Gif:inline3am"..anubis, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(DyLer.."Add:Rd:Manager:video_note:inline3am"..anubis, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(DyLer.."Add:Rd:Manager:Video:inline3am"..anubis, msg.content.video.video.remote.id)  
Redis:set(DyLer.."Add:Rd:Manager:Videoc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(DyLer.."Add:Rd:Manager:Photo:inline3am"..anubis, idPhoto)  
Redis:set(DyLer.."Add:Rd:Manager:Photoc:inline3am"..anubis, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"↯︙ الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
if not Redis:sismember(DyLer.."List:Manager:inline3am", text) then
 Redis:del(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
   return send(msg_chat_id,msg_id,"↯︙ لا يوجد رد لهذه الكلمه","md",true)  
  end
  Redis:del(DyLer.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(DyLer.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(DyLer.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(DyLer.."Add:Rd:Manager:Text:inline3am"..text)   
  Redis:del(DyLer.."Add:Rd:Manager:Photo:inline3am"..text)
  Redis:del(DyLer.."Add:Rd:Manager:Photoc:inline3am"..text)
  Redis:del(DyLer.."Add:Rd:Manager:Video:inline3am"..text)
  Redis:del(DyLer.."Add:Rd:Manager:Videoc:inline3am"..text)  
  Redis:del(DyLer.."Add:Rd:Manager:File:inline3am"..text)
  Redis:del(DyLer.."Add:Rd:Manager:video_note:inline3am"..text)
  Redis:del(DyLer.."Add:Rd:Manager:Audio:inline3am"..text)
  Redis:del(DyLer.."Add:Rd:Manager:Audioc:inline3am"..text)
  Redis:del(DyLer.."Rd:Manager:inline3am:text"..text)
  Redis:del(DyLer.."Rd:Manager:inline3am:link"..text)
Redis:del(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(DyLer.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id,"↯︙ تم حذف الرد من الردود الانلاين العامه","md",true)  
return false
end
end
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(DyLer) then
  if Redis:get(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(DyLer.."Text:Manager:inline3am"..msg.sender.user_id..":", text)
  Redis:del(DyLer.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(DyLer.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(DyLer.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(DyLer.."Add:Rd:Manager:Text:inline3am"..text)   
  ...
  Redis:del(DyLer.."Rd:Manager:inline3am:text"..text)
  Redis:del(DyLer.."Rd:Manager:inline3am:link"..text)
  Redis:sadd(DyLer.."List:Manager:inline3am", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text == "اضف رد انلاين عام" then
  ...
  Redis:set(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and not Redis:get(DyLer.."Status:Reply:inline3am"..msg_chat_id) then
local btext = Redis:get(DyLer.."Rd:Manager:inline3am:text"..text)
local blink = Redis:get(DyLer.."Rd:Manager:inline3am:link"..text)
local anemi = Redis:get(DyLer.."Add:Rd:Manager:Gif:inline3am"..text)   
local veico = Redis:get(DyLer.."Add:Rd:Manager:Vico:inline3am"..text)   
local stekr = Redis:get(DyLer.."Add:Rd:Manager:Stekrs:inline3am"..text)     
local Texingt = Redis:get(DyLer.."Add:Rd:Manager:Text:inline3am"..text)   
local photo = Redis:get(DyLer.."Add:Rd:Manager:Photo:inline3am"..text)
local photoc = Redis:get(DyLer.."Add:Rd:Manager:Photoc:inline3am"..text)
local video = Redis:get(DyLer.."Add:Rd:Manager:Video:inline3am"..text)
local videoc = Redis:get(DyLer.."Add:Rd:Manager:Videoc:inline3am"..text)  
local document = Redis:get(DyLer.."Add:Rd:Manager:File:inline3am"..text)
local audio = Redis:get(DyLer.."Add:Rd:Manager:Audio:inline3am"..text)
local audioc = Redis:get(DyLer.."Add:Rd:Manager:Audioc:inline3am"..text)
local video_note = Redis:get(DyLer.."Add:Rd:Manager:video_note:inline3am"..text)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين عام" then
  ...
  Redis:set(DyLer.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true2")
  return send(msg_chat_id,msg_id,"↯︙ ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
  end 
...
if text == ("الردود الانلاين العامه") then
  ...
  text = "↯︙ قائمه الردود الانلاين \n- - - - - - - - -\n"
  for k,v in pairs(list) do
  if Redis:get(DyLer.."Add:Rd:Manager:Gif:inline3am"..v) then
  db = "متحركه ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Vico:inline3am"..v) then
  db = "بصمه ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Stekrs:inline3am"..v) then
  db = "ملصق ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Text:inline3am"..v) then
  db = "رساله ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Photo:inline3am"..v) then
  db = "صوره ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Video:inline3am"..v) then
  db = "فيديو ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:File:inline3am"..v) then
  db = "ملف ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:Audio:inline3am"..v) then
  db = "اغنيه ↯︙"
  elseif Redis:get(DyLer.."Add:Rd:Manager:video_note:inline3am"..v) then
  db = "بصمه فيديو ↯︙"
  end
  text = text..""..k.." - {"..v.."} - {"..db.."}\n"
  end
...
Redis:sadd(DyLer..'ban:online',txx)
...
if txx:match("^-100(%d+)$") then
Redis:srem(DyLer..'ban:online',txx)
...
LuaTele.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@IIIIIIQ")
sleep(1)
...
balas = 10
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
return send(msg.chat_id,msg.id, "•  لديك حساب بنكي مسبقاً\n\n•  لعرض معلومات حسابك اكتب\n⇠ `حسابي`","md",true)
end
Redis:setex(DyLer.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(DyLer.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "ماستر" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
Redis:set(DyLer.."bobna"..msg.sender.user_id,news)
Redis:set(DyLer.."boob"..msg.sender.user_id,balas)
Redis:set(DyLer.."boobb"..msg.sender.user_id,creditcc)
Redis:set(DyLer.."bbobb"..msg.sender.user_id,text)
Redis:set(DyLer.."boballname"..creditcc,news)
Redis:set(DyLer.."boballbalc"..creditcc,balas)
Redis:set(DyLer.."boballcc"..creditcc,creditcc)
Redis:set(DyLer.."boballban"..creditcc,text)
Redis:set(DyLer.."boballid"..creditcc,banid)
Redis:sadd(DyLer.."booob",msg.sender.user_id)
Redis:del(DyLer.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك دايلر 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditcc.."` )\n•  نوع البطاقة ↢ ( ماستر 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)  
end 
if text == "فيزا" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
Redis:set(DyLer.."bobna"..msg.sender.user_id,news)
Redis:set(DyLer.."boob"..msg.sender.user_id,balas)
Redis:set(DyLer.."boobb"..msg.sender.user_id,creditvi)
Redis:set(DyLer.."bbobb"..msg.sender.user_id,text)
Redis:set(DyLer.."boballname"..creditvi,news)
Redis:set(DyLer.."boballbalc"..creditvi,balas)
Redis:set(DyLer.."boballcc"..creditvi,creditvi)
Redis:set(DyLer.."boballban"..creditvi,text)
Redis:set(DyLer.."boballid"..creditvi,banid)
Redis:sadd(DyLer.."booob",msg.sender.user_id)
Redis:del(DyLer.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك دايلر 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditvi.."` )\n•  نوع البطاقة ↢ ( فيزا 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)   
end 
...
Redis:set(DyLer.."bobna"..msg.sender.user_id,news)
Redis:set(DyLer.."boob"..msg.sender.user_id,balas)
Redis:set(DyLer.."boobb"..msg.sender.user_id,creditex)
Redis:set(DyLer.."bbobb"..msg.sender.user_id,text)
Redis:set(DyLer.."boballname"..creditex,news)
Redis:set(DyLer.."boballbalc"..creditex,balas)
Redis:set(DyLer.."boballcc"..creditex,creditex)
Redis:set(DyLer.."boballban"..creditex,text)
Redis:set(DyLer.."boballid"..creditex,banid)
Redis:sadd(DyLer.."booob",msg.sender.user_id)
Redis:del(DyLer.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك دايلر 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditex.."` )\n•  نوع البطاقة ↢ ( اكسبرس 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)   
end 
...
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
Redis:srem(DyLer.."booob", msg.sender.user_id)
Redis:del(DyLer.."boob"..msg.sender.user_id)
Redis:del(DyLer.."boobb"..msg.sender.user_id)
Redis:del(DyLer.."zrfff"..msg.sender.user_id)
Redis:srem(DyLer.."zrfffid", msg.sender.user_id)
...
if msg.ControllerBot then
Redis:del(DyLer.."booob")
Redis:del(DyLer.."boob")
Redis:del(DyLer.."boobb")
Redis:del(DyLer.."zrfff")
Redis:del(DyLer.."zrfffid")
...
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
ballancee = Redis:get(DyLer.."boob"..msg.sender.user_id) or 0
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*•  دايلر ماعنده حساب بالبنك 🤣*","md",true)  
return false
end
if Redis:sismember(DyLer.."booob",Remsg.sender.user_id) then
ballanceed = Redis:get(DyLer.."boob"..Remsg.sender.user_id) or 0
...
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
cccc = Redis:get(DyLer.."boobb"..msg.sender.user_id)
uuuu = Redis:get(DyLer.."bbobb"..msg.sender.user_id)
pppp = Redis:get(DyLer.."zrfff"..msg.sender.user_id) or 0
ballancee = Redis:get(DyLer.."boob"..msg.sender.user_id) or 0
...
if Redis:sismember(DyLer.."booob",Remsg.sender.user_id) then
ccccc = Redis:get(DyLer.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(DyLer.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(DyLer.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(DyLer.."boob"..Remsg.sender.user_id) or 0
Redis:srem(DyLer.."booob", Remsg.sender.user_id)
Redis:del(DyLer.."boob"..Remsg.sender.user_id)
Redis:del(DyLer.."boobb"..Remsg.sender.user_id)
Redis:del(DyLer.."zrfff"..Remsg.sender.user_id)
Redis:srem(DyLer.."zrfffid", Remsg.sender.user_id)
...
if Redis:sismember(DyLer.."booob",coniss) then
ccccc = Redis:get(DyLer.."boobb"..coniss)
uuuuu = Redis:get(DyLer.."bbobb"..coniss)
ppppp = Redis:get(DyLer.."zrfff"..coniss) or 0
ballanceed = Redis:get(DyLer.."boob"..coniss) or 0
Redis:srem(DyLer.."booob", coniss)
Redis:del(DyLer.."boob"..coniss)
Redis:del(DyLer.."boobb"..coniss)
Redis:del(DyLer.."zrfff"..coniss)
Redis:srem(DyLer.."zrfffid", coniss)
send(msg.chat_id,msg.id, "•  الاسم ↢ "..news.."\n•  الحساب ↢ `"..ccccc.."`\n•  بنك ↢ ( دايلر )\n•  نوع ↢ ( "..uuuuu.." )\n•  الرصيد ↢ ( "..ballanceed.." دولار 💵 )\n•  الزرف ↢ ( "..ppppp.." دولار 💵 )\n•  مسكين مسحت حسابه \n.","md",true)
else
send(msg.chat_id,msg.id, "•  ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if Redis:get(DyLer.."boballcc"..coniss) then
local yty = Redis:get(DyLer.."boballname"..coniss)
local dfhb = Redis:get(DyLer.."boballbalc"..coniss)
local fsvhh = Redis:get(DyLer.."boballban"..coniss)
...
local coniss = tonumber(coniss)
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
if Redis:get(DyLer.."iiooooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(DyLer.."iiooooo" .. msg.sender.user_id))
...
Redis:set(DyLer.."boob"..msg.sender.user_id , math.floor(ballanceekkku))
Redis:setex(DyLer.."iiooooo" .. msg.sender.user_id,1200, true)
...
local coniss = tonumber(coniss)
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
if Redis:get(DyLer.."iioooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(DyLer.."iioooo" .. msg.sender.user_id))
...
Redis:incrby(DyLer.."boob"..msg.sender.user_id , math.floor(ballanceekk))
Redis:setex(DyLer.."iioooo" .. msg.sender.user_id,1200, true)
...
local coniss = tonumber(coniss)
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
if Redis:get(DyLer.."iiooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(DyLer.."iiooo" .. msg.sender.user_id)) 
...
Redis:incrby(DyLer.."boob"..msg.sender.user_id , coniss)
Redis:setex(DyLer.."iiooo" .. msg.sender.user_id,1200, true)
...
Redis:decrby(DyLer.."boob"..msg.sender.user_id , coniss)
Redis:setex(DyLer.."iiooo" .. msg.sender.user_id,1200, true)
...
local coniss = coniss:gsub('-','')
local coniss = tonumber(coniss)
if not Redis:sismember(DyLer.."booob",msg.sender.user_id) then
...
Redis:set(DyLer.."transn"..msg.sender.user_id,coniss)
Redis:setex(DyLer.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(DyLer.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(DyLer.."boobb"..msg.sender.user_id)
uuuu = Redis:get(DyLer.."bbobb"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(DyLer.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(DyLer.."transn" .. msg.sender.user_id)
...
if Redis:get(DyLer.."boballcc"..text) then
local UserNamey = Redis:get(DyLer.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(DyLer.."boballid"..text)
...
local fsvhh = Redis:get(DyLer.."boballban"..text)
UserNameyr = UserNamey / 10
UserNameyy = UserNamey - UserNameyr
Redis:decrby(DyLer.."boob"..msg.sender.user_id , UserNamey)
Redis:incrby(DyLer.."boob"..fsvhhh , math.floor(UserNameyy))
send(msg.chat_id,msg.id, "حوالة صادرة من بنك دايلر\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمستلم : "..newss.."\nالحساب رقم : `"..text.."`\nنوع البطاقة : "..fsvhh.."\nخصمت 10% رسوم تحويل\nالمبلغ : "..UserNameyy.." دولار 💵","md",true)
send(fsvhhh,0, "حوالة واردة من بنك دايلر\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمبلغ : "..UserNameyy.." دولار 💵","md",true)
Redis:del(DyLer.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(DyLer.."transn" .. msg.sender.user_id)
else
send(msg.chat_id,msg.id, "•  مافيه حساب بنكي كذا","md",true)
...
if Redis:sismember(DyLer.."booob",Remsg.sender.user_id) then
Redis:incrby(DyLer.."boob"..Remsg.sender.user_id , coniss)
ccccc = Redis:get(DyLer.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(DyLer.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(DyLer.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(DyLer.."boob"..Remsg.sender.user_id) or 0
...
if Redis:sismember(DyLer.."booob",Remsg.sender.user_id) then
Redis:decrby(DyLer.."boob"..Remsg.sender.user_id , coniss)
ccccc = Redis:get(DyLer.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(DyLer.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(DyLer.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(DyLer.."boob"..Remsg.sender.user_id) or 0
...
local bank_users = Redis:smembers(DyLer.."booob")
...
local mony = Redis:get(DyLer.."boob"..v)
...
local ty_users = Redis:smembers(DyLer.."zrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(DyLer.."zrfff"..v)
...
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
if Redis:get(DyLer.."iioo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(DyLer.."iioo" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  من شوي اخذت بخشيش استنى ( "..time_ex.." )","md",true)
end
local jjjo = math.random(1,200);
Redis:incrby(DyLer.."boob"..msg.sender.user_id , jjjo)
send(msg.chat_id,msg.id,"•  تكرم وهي بخشيش "..jjjo.." دولار 💵","md",true)
Redis:setex(DyLer.."iioo" .. msg.sender.user_id,600, true)
else
send(msg.chat_id,msg.id, "•  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:get(DyLer.."polic" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(DyLer.."polic" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  انتا بالسجن 🏤 استنى ( "..time_ex.." )","md",true)
end
if Redis:get(DyLer.."hrame" .. Remsg.sender.user_id) then
local time_ex = ctime(Redis:ttl(DyLer.."hrame" .. Remsg.sender.user_id))
...
local ballanceed = Redis:get(DyLer.."boob"..Remsg.sender.user_id) or 0
Redis:incrby(DyLer.."boob"..msg.sender.user_id , hrame)
Redis:decrby(DyLer.."boob"..Remsg.sender.user_id , hrame)
Redis:setex(DyLer.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(DyLer.."zrfff"..msg.sender.user_id,hrame)
Redis:sadd(DyLer.."zrfffid",msg.sender.user_id)
send(msg.chat_id,msg.id, "•  خذ يالحرامي زرفته "..hrame.." دولار 💵\n.","md",true)
else
Redis:setex(DyLer.."polic" .. msg.sender.user_id,300, true)
...
if Redis:sismember(DyLer.."booob",msg.sender.user_id) then
if Redis:get(DyLer.."iiioo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(DyLer.."iiioo" .. msg.sender.user_id))
...
if job == "طيار" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 500)
ratbk = "500"
your_job = "طيار 🚀"
elseif job == "محامي" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 300)
ratbk = "300"
your_job = "محامي 👨‍🎓"
elseif job == "دكتور" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 600)
ratbk = "600"
your_job = "دكتور 👨‍🔬‍"
elseif job == "خباز" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 100)
ratbk = "100"
your_job = "خباز ‍💆‍♂️"
elseif job == "مدير بنك" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 800)
ratbk = "800"
your_job = "مدير بنك ‍👨‍💼"
elseif job == "قلب ستيفن" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 1000)
ratbk = "1000"
your_job = "قلب ستيفن ♥"
elseif job == "مدرس" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 400)
ratbk = "400"
your_job = "مدرس 🤵"
elseif job == "فتاحه" then
Redis:incrby(DyLer.."boob"..msg.sender.user_id , 5000)
ratbk = "5000"
your_job = "فتاحه 💋"
end
local ballancee = Redis:get(DyLer.."boob"..msg.sender.user_id) or 0
send(msg.chat_id,msg.id,"• اشعار ايداع "..neews.."\n• وظيفتك : "..your_job.."\n• المبلغ : "..ratbk.." دولار 💵\n• نوع العملية : اضافة راتب\n• رصيدك الحين : "..ballancee.." دولار 💵","md",true)
Redis:setex(DyLer.."iiioo" .. msg.sender.user_id,600, true)
else
send(msg.chat_id,msg.id, "•  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if not Redis:sismember(DyLer.."booob",Remsg.sender.user_id) then
return send(msg.chat_id,msg.id,"• ما عنده حساب بنكي")
end
if Redis:get(DyLer..'hgomm'..msg.sender.user_id) then
return send(msg.chat_id,msg.id,"• استنا "..ctime(Redis:ttl(DyLer..'hgomm'..msg.sender.user_id)).." وبعدين هاجم تاني")
end
...
local coniss = coniss:gsub('-','')
local coniss = tonumber(coniss)
local my_balance = Redis:get(DyLer.."boob"..msg.sender.user_id) or 0
local his_balance = Redis:get(DyLer.."boob"..Remsg.sender.user_id) or 0
...
Redis:incrby(DyLer.."boob"..msg.sender.user_id , coniss)
Redis:decrby(DyLer.."boob"..Remsg.sender.user_id , coniss)
local balance = Redis:get(DyLer.."boob"..msg.sender.user_id) or 0
local Hbalance = Redis:get(DyLer.."boob"..Remsg.sender.user_id) or 0
Redis:setex(DyLer..'hgomm'..msg.sender.user_id,300,true)
...
if text and Redis:get(DyLer..msg.chat_id..msg.sender.user_id.."txtrtb") then
local balance = Redis:get(DyLer.."boob"..msg.sender.user_id)
if text == 'مميز' and tonumber(balance)  >= 2000 then
Redis:decrby(DyLer.."boob"..msg.sender.user_id , 2000)
Redis:sadd(DyLer.."Special:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(DyLer..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(DyLer.."boob"..msg.sender.user_id , 4000)
Redis:sadd(DyLer.."Admin:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(DyLer..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(DyLer.."boob"..msg.sender.user_id , 6000)
Redis:sadd(DyLer.."Manger:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(DyLer..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(DyLer.."boob"..msg.sender.user_id , 8000)
Redis:sadd(DyLer.."Creator:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(DyLer..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:setex(DyLer..msg.chat_id..msg.sender.user_id.."txtrtb",180,true)
...
Redis:set(DyLer..'rdod:sh'..msg.chat_id,true)
...
Redis:del(DyLer..'rdod:sh'..msg.chat_id)
send(msg_chat_id,msg_id,'\n*↯︙ تم تعطيل ردود السورس * ',"md",true)  
end
if Redis:get(DyLer..'rdod:sh'..msg.chat_id) then
...
txx = "↯︙ قائمه الردود \n- - - - - - - - -\n"
for k,v in pairs(list) do
if Redis:get(DyLer.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه ↯︙"
elseif Redis:get(DyLer.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو ↯︙"
end
txx = txx..""..k.." - {"..v.."} - {"..db.."}\n"
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/XFFX5/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/HGFIC/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
Redis:del(DyLer..msg.sender.user_id..msg.chat_id.."num")
...
send(msg.chat_id,msg.id,"↯︙ اهلا بك في الحاسبة الرقمية الخاصة بسورس دايلر","md",true, false, false, true, start_mrkup)
return false 
end
...
Redis:set(DyLer..msg.chat_id..msg.sender.user_id.."replace",true)
...
local list = Redis:smembers(DyLer.."Words:r")
for k,v in pairs(list) do
Redis:del(DyLer.."Word:Replace"..v)
end
Redis:del(DyLer.."Words:r")
...
for k,v in pairs(list) do 
cmdd = Redis:get(DyLer.."Word:Replace"..v)
txx = txx..k.." - "..v.." -- "..cmdd.."\n"
end
...
local datar = {data = {{text = "‹ DyLer TeAm ›" , url = 'https://t.me/IIIIIIQ'}}}
for i = 1,5 do
...
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(DyLer.."gamebot:newqus"..msg.chat_id,text)
Redis:srem(DyLer.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\nتم مسح السؤال بنجاح') 
end
end

if text and text:match("^(.*)$") then
if Redis:get(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
Redis:set(DyLer.."gamebot:newqus"..msg.chat_id,text)
Redis:sadd(DyLer.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\nتم حفظ السؤال بنجاح \n ارسل الجواب الاول') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(DyLer.."gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."gamebot:newqus:as1"..quschen,text)
Redis:set(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(DyLer.."gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."gamebot:newqus:as2"..quschen,text)
Redis:set(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(DyLer.."gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."gamebot:newqus:as3"..quschen,text)
Redis:set(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(DyLer.."gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."gamebot:newqus:as0"..quschen,text)
Redis:set(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\nتم حفظ الاجوبه \n ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(DyLer.."gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."gamebot:newqus:as4"..quschen,text)
Redis:set(DyLer.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\nتم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(DyLer.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:srem(DyLer.."lkz:gamebot:new1", text)
send(msg_chat_id,msg_id, '\nتم مسح الغز بنجاح')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
Redis:set(DyLer.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:sadd(DyLer.."lkz:gamebot:new1", text)
send(msg_chat_id,msg_id, '\nتم حفظ اللغز بنجاح \n ارسل الجواب الاول')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(DyLer.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
send(msg_chat_id,msg_id, ' \n ارسل الجواب الثاني')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(DyLer.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
send(msg_chat_id,msg_id, '\n ارسل الجواب الثالث')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(DyLer.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
send(msg_chat_id,msg_id, ' \n ارسل الجواب الصحيح')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(DyLer.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(DyLer.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
send(msg_chat_id,msg_id, '\nتم حفظ الجواب الصحيح')
return false 
end
end
...
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(DyLer.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"ارسل اللغز الان ")
end
...
local list = Redis:smembers(DyLer.."lkz:gamebot:new1")
t = "• الالغاز : \n"
for k,v in pairs(list) do
t = t..""..k.."- (["..v.."])\n"
end
...
Redis:del(DyLer.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(DyLer.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(DyLer.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(DyLer.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(DyLer.."lkz:gamebot:newqus:as4"..quschen)
...
SuperCreator = Redis:sismember(DyLer.."SuperCreator:Group"..msg.chat_id,UserId_Info.id) 
Creator = Redis:sismember(DyLer.."Creator:Group"..msg.chat_id,UserId_Info.id)
Manger = Redis:sismember(DyLer.."Manger:Group"..msg.chat_id,UserId_Info.id)
Admin = Redis:sismember(DyLer.."Admin:Group"..msg.chat_id,UserId_Info.id)
Special = Redis:sismember(DyLer.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(DyLer.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(DyLer.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
SuperCreator = Redis:sismember(DyLer.."SuperCreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Creator = Redis:sismember(DyLer.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Manger = Redis:sismember(DyLer.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Admin = Redis:sismember(DyLer.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Special = Redis:sismember(DyLer.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(DyLer.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(DyLer.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
photo = "https://t.me/lllllklkj/70"
local T =[[
↯︙Welcome To Source
↯︙[ TeAm. DyLer ](t.me/IIIIIIQ)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '( Source channel )', url = "https://t.me/IIIIIIQ"}
},
{
{text = '(Source Dev)', url = "https://t.me/LLQLLIL"},{text = '( Exp Source )', url = "https://t.me/DGGEO"},
},
{
...
Redis:setex(DyLer.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(DyLer.."Name:Bot") 
return send(msg_chat_id,msg_id,"↯︙ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(DyLer.."Name:Bot") or "دايلر") then
if Redis:get(DyLer.."name bot type : ") == "photo" then
  local photo = LuaTele.getUserProfilePhotos(DyLer)
  local UserInfo = LuaTele.getUser(DyLer)
  local Name_User = UserInfo.first_name
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(DyLer.."Name:Bot") or "دايلر")
    local NameBots = {
"قلب "..NamesBot ,
"كول حبيبي ؟ شرايود 😂",
...
x = x + 1
Redis:srem(DyLer..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,DyLer)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
send(Get_Chat.id,0,'*↯︙ البوت عضو في الكروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(DyLer..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(DyLer..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(DyLer..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(DyLer..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(DyLer.."Game:Smile"..msg.chat_id,SM)
...
Redis:set(DyLer.."mshaher"..msg.chat_id,name)
...
if Redis:get(DyLer.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","دايلر","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(DyLer.."Game:Monotonous"..msg.chat_id,name)
name = string.gsub(name,"سحور","س ر و ح")
name = string.gsub(name,"سياره","ه ر س ي ا")
name = string.gsub(name,"استقبال","ل ب ا ت ق س ا")
name = string.gsub(name,"قنفذ","ذ ق ن ف")
name = string.gsub(name,"ايفون","و ن ف ا")
name = string.gsub(name,"دايلر","ر و ف ر ي")
...
Redis:set(DyLer.."Game:Riddles"..msg.chat_id,name)
...
if Redis:get(DyLer.."Status:Games"..msg.chat_id) then
Redis:del(DyLer.."Set:Country"..msg.chat_id)
...
Redis:set(DyLer.."Game:Countrygof"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(DyLer.."Status:Games"..msg.chat_id) then
Redis:del(DyLer.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(DyLer.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(DyLer.."Status:Games"..msg.chat_id) then
Redis:del(DyLer.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(DyLer.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(DyLer.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(DyLer.."Game:Difference"..msg.chat_id,name)
...
Redis:set(DyLer.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(DyLer.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,Xnxx )  
...
Redis:incrby(DyLer.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:incrby(DyLer.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(DyLer.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط', 'رفع مطور')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي', 'رفع مطور ثانوي')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ج', 'زواج')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قف', 'قفل الاشعارات')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف', 'فتح الاشعارات')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر', 'الرابط')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الردود', 'رر')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تث', 'تثبيت')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تاك', 'تاك للكل')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ', 'غنيلي')
Redis:set(DyLer.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ري', 'ريمكس')
return send(msg_chat_id,msg_id,[[*
...
Redis:del(DyLer.."smsme"..msg.chat_id)
...
Redis:set(DyLer.."smsme"..msg.chat_id,true)
send(msg.chat_id,msg.id,"↯︙ تم تعطيل سمسمي")
end
if not Redis:get(DyLer.."smsme"..msg.chat_id) then
if text and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Message_Reply and Message_Reply.sender and tonumber(Message_Reply.sender.user_id) == tonumber(DyLer) then
...
if msg and Redis:get(DyLer.."DyLer:Tagat"..msg.chat_id) then
if not Redis:get(DyLer..":"..msg.chat_id..":tag") then
...
Redis:setex(DyLer..":"..msg.chat_id..":tag",30,true)
...
local GetLink = Redis:get(DyLer.."Group:Link"..coree[1]) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return send(msg_chat_id, msg_id, "↯︙Link Group : \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
if text and Redis:get(DyLer..msg.sender.user_id.."hash") and Redis:get(DyLer..msg.sender.user_id.."num") and Redis:get(DyLer..msg.sender.user_id..'pass') then
if text == "الغاء" or text == "↯︙ الغاء" then
Redis:del(DyLer..msg.sender.user_id.."hash")
Redis:del(DyLer..msg.sender.user_id.."num")
Redis:del(DyLer..msg.sender.user_id.."pass")
local k = {
...
local hash = Redis:get(DyLer..msg.sender.user_id.."hash")
local num = Redis:get(DyLer..msg.sender.user_id.."num")
local pass = Redis:get(DyLer..msg.sender.user_id.."pass")
...
if text and Redis:get(DyLer..msg.sender.user_id.."hash") and Redis:get(DyLer..msg.sender.user_id.."num") and not Redis:get(DyLer..msg.sender.user_id..'pass') then
if text == "الغاء" or text == "↯︙ الغاء" then
Redis:del(DyLer..msg.sender.user_id.."hash")
Redis:del(DyLer..msg.sender.user_id.."num")
local k = {
...
Redis:set(DyLer..msg.sender.user_id..'pass',text)
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
Redis:set(DyLer..msg.sender.user_id.."hash",json.result.access_hash)
Redis:set(DyLer..msg.sender.user_id.."num",num)
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
if text == '/start' then
Redis:sadd(DyLer..'Num:User:Pv',msg.sender.user_id)  
if not msg.Devss then
local photo = LuaTele.getUserProfilePhotos(DyLer)
if not Redis:get(DyLer.."Start:Bot") then
local CmdStart = '*\n↯︙ أهلآ بك في بوت '..(Redis:get(DyLer.."Name:Bot") or "دايلر")..
...
{
{text = '‹ مبرمج السورس ›', url = 't.me/'..chdevolper..''}, {text = '‹ قناة السورس ›', url = 't.me/'..chsource..''}, 
},
}
}
...
LuaTele.sendPhoto(msg.chat_id, msg.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,Redis:get(DyLer.."Start:Bot"),"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup )
end
else
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
...
if text == "٠ تفعيل البوت بالصوره ٠" then
  ...
  Redis:set(DyLer.."name bot type : ", "photo")
...
Redis:set(DyLer.."name bot type : ", "text")
...
Redis:setex(DyLer.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not Redis:get(DyLer.."chmembers") then
return send(msg_chat_id,msg_id,'\n*↯︙ الامر معطل بالفعل* ',"md",true)  
end
Redis:del(DyLer.."chmembers")
...
if not Redis:get(DyLer.."chfalse") then
return send(msg_chat_id,msg_id,'\n*↯︙ عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(DyLer.."chmembers","on")
...
if Redis:get(DyLer.."set:chs"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(DyLer.."set:chs"..msg.sender.user_id)
...
Redis:del(DyLer.."set:chs"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ معرف ‹ DyLer TeAm › ',"md",true)  
dofile('DyLer.lua')  
else
send(msg_chat_id,msg_id,'المعرف خطأ ',"md",true)  
end
...
if not msg.Devss then
if Redis:get(DyLer.."TwaslBot") and not Redis:sismember(DyLer.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(DyLer.."Twasl:UserId"..msg.date,172800,IdUser)
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/IIIIIIQ"}},
}
},
},
}
https.request("https://api.telegram.org/bot"..Token..'/answerInlineQuery?inline_query_id='..data.id..'&switch_pm_text=@LLQLLIL&switch_pm_parameter=start&results='..JSON.encode(resuult))
end
if Text and Text:match("(.*)@(.*)") then
...
Redis:srem(DyLer.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(DyLer..'*'..'-100'..data.supergroup.id..'*')
Redis:del(DyLer.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(DyLer.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(DyLer.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(DyLer.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(DyLer.."Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(DyLer..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
elseif tonumber(Message_Edit.sender.user_id) == 935580261 then
data.The_Controller = 1
elseif The_ControllerAll(Message_Edit.sender.user_id) == true then  
data.The_Controller = 1
elseif Redis:sismember(DyLer.."Devss:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(DyLer.."Dev:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(DyLer.."Ownerss:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(DyLer.."SuperCreator:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(DyLer.."Creator:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(DyLer.."Manger:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(DyLer.."Admin:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(DyLer.."Special:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender.user_id) == tonumber(DyLer) then
...
Redis:incr(DyLer..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(DyLer.."Lock:edit"..data.chat_id) then
...
local get = Redis:get(DyLer..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(DyLer..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(DyLer..IdUser..ChatId.."num")
if math then
...
Redis:del(DyLer..IdUser..ChatId.."num")
else
LuaTele.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(DyLer..IdUser..ChatId.."num",gxx)
...
if tonumber(IdUser) == tonumber(sendrr) then
Redis:del(DyLer..IdUser..ChatId.."num")
edit(ChatId,Msg_id,"↯︙ اهلا بك في الحاسبة الرقمية الخاصة بسورس دايلر" , 'html', false, false, calc_markup)
else
LuaTele.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
data.The_Controller = 1
elseif tonumber(IdUser) == 935580261 then
data.The_Controller = 1
elseif The_ControllerAll(IdUser) == true then  
data.The_Controller = 1
elseif Redis:sismember(DyLer.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(DyLer.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(DyLer.."Ownerss:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(DyLer.."SuperCreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(DyLer.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(DyLer.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(DyLer.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(DyLer.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(DyLer) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
Redis:incrby(DyLer.."Num:Add:Games"..ChatId..IdUser, 1)  
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    local zwga_name = LuaTele.getUser(zwga_id).first_name
    local zwg_name = LuaTele.getUser(zwg_id).first_name
    Redis:set(DyLer..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(DyLer..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(DyLer..ChatId..IdUser.."zkrf:", "zeng")
...
if Text and Text:match('(.*)/a(.*)') then
    ...
    local z_text = Redis:get(DyLer..ChatId..IdUser.."zkrf:text")
    Redis:set(DyLer..ChatId..IdUser.."zkrf:num", z_num)
    if tonumber(UserId) == tonumber(IdUser) then
...
if Text and Text:match('(.*)/b(.*)') then
      ...
      local z_text = Redis:get(DyLer..ChatId..IdUser.."zkrf:text")
      local z_save = Redis:get(DyLer..ChatId..IdUser.."zkrf:num")
      if tonumber(UserId) == tonumber(IdUser) then
        local api = https.request("https://api-jack.ml/api19.php?text="..URL.escape(z_text))
        local zkrf = JSON.decode(api)
        ...
        Redis:del(DyLer..ChatId..IdUser.."zkrf:text")
        Redis:del(DyLer..ChatId..IdUser.."zkrf:num")
      end
      end
-- z  emo
...
if Text and Text:match('(%d+)/zar') then
    ...
    if tonumber(UserId) == tonumber(IdUser) then
      Redis:set(DyLer..ChatId..IdUser.."zkrf:", "zar")
      edit(ChatId, Msg_id, "↯︙Send ur Naeme .\n \n↯︙ارسل اسمك الان ليتم زخرفتة", "md",false)
    end
    end
...
Redis:del(DyLer.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:array"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:On"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(DyLer.."Set:Rd:mz"..IdUser..":"..ChatId)
...
if Text and Text:match('(%d+)/cancelkit') then
    ...
    Redis:del(DyLer.."Set:kit"..IdUser..":"..ChatId)
    edit(ChatId,Msg_id,"تم الغاء الامر بنجاح", 'md', true, false, reply_markup)
    end
    end
...
if Redis:get(DyLer..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(DyLer..'Set:array'..IdUser..':'..ChatId)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ DyLer',url='https://t.me/IIIIIIQ'}},
}
...
*]]
Redis:set(DyLer.."youtube"..IdUser..ChatId,'mp3')
...
↯︙ارسل الاسم الان لاقوم بتحميله لك
*]]
Redis:set(DyLer.."youtube"..IdUser..ChatId,'mp4')
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(DyLer.."ChekBotAdd",UserId[2])
local U = LuaTele.getUser(IdUser)
Redis:set(DyLer.."Status:Id"..UserId[2],true) ;Redis:del(DyLer.."Status:Reply"..UserId[2]) ;Redis:del(DyLer.."Status:ReplySudo"..UserId[2]) ;Redis:set(DyLer.."Status:BanId"..UserId[2],true) ;Redis:set(DyLer.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(DyLer.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(DyLer.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(DyLer.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(DyLer.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(DyLer.."BanGroup:Group"..ChatId,replyy) 
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(DyLer.."BanGroup:Group"..ChatId,replyy) 
...
Redis:incrby(DyLer.."Num:Add:Games"..ChatId..IdUser,3)  
...
Redis:srem(DyLer.."Dev:Groups",info[2])
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:srem(DyLer.."Special:Group"..ChatId,IdUser)
Redis:srem(DyLer.."Admin:Group"..ChatId,IdUser)
Redis:srem(DyLer.."Manger:Group"..ChatId,IdUser)
Redis:srem(DyLer.."Creator:Group"..ChatId,IdUser)
Redis:srem(DyLer.."SuperCreator:Group"..ChatId,IdUser)
Redis:srem(DyLer.."Dev:Groups",IdUser) 
Redis:srem(DyLer.."Ownerss:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(DyLer.."SuperCreator:Group"..ChatId,UserId[2]) then
Redis:srem(DyLer.."SuperCreator:Group"..ChatId,UserId[2])
else
Redis:sadd(DyLer.."SuperCreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(DyLer.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(DyLer.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(DyLer.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(DyLer.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(DyLer.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(DyLer.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(DyLer.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(DyLer.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(DyLer.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(DyLer.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(DyLer.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(DyLer.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(DyLer.."Creator:Group"..ChatId,UserId[2])
Redis:srem(DyLer.."SuperCreator:Group"..ChatId,UserId[2])
Redis:srem(DyLer.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(DyLer.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(DyLer.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(DyLer.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(DyLer.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(DyLer.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(DyLer.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(DyLer.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
*]]
Redis:set(DyLer.."toar"..IdUser,"on")
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
*]]
Redis:set(DyLer.."toen"..IdUser,"on")
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
data = {
{
{text = 'العاب السورس', data = IdUser..'/normgm'}, {text = 'العاب انلاين', data = IdUser..'/degm'}, 
},
{
{text = 'القائمه الرئيسيه', data = IdUser..'/helpall'},
},
...
local TextHelp = [[*
↯︙ أهلا بك في قائمة العاب سورس دايلر اختر نوع الالعاب 
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
↯︙ مرحبا بك في الالعاب المتطورة الخاص بسورس دايلر 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(DyLer.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(DyLer.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(DyLer.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(DyLer.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(DyLer.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(DyLer.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(DyLer..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(DyLer.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."BanGroup:Group"..ChatId) 
edit(ChatId,Msg_id,"↯︙ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(DyLer.."SilentGroup:Group"..ChatId) 
