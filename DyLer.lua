...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من الصاكين قبل كدة 🙃 ").Reply,"md",true)  
else
Redis:srem(DyLer.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من الصاكين لازم ياخد دروس رجوله😂🌚 ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙ تم تنزيله من الانبياء لازم ياخد دروس رجوله😂🌚 ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙محطوط ف قايمة الصاكين من  بدري 😂 ").Reply,"md",true)  
else
...
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"↯︙تم رفعه صاكه تخبل بالكروب ").Reply,"md",true)  
else
...
data = {
{
{text = ' (Source Dev)', url = 't.me/Q0OO0'}, 
},
}
}
...
{
{text = '(Source Dev)', url = "https://t.me/Q0OO0"},{text = '( Exp Source )', url = "https://t.me/DGGEO"},
},
{
...
return send(msg_chat_id,msg_id,"مطور سورس دايلر ↫ @"..chdevolper.."","html",true, false, false, true, reply_markup)
end
if text == '- DyLer TeAm .' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return send(msg_chat_id,msg_id,"- DyLer TeAm . ↫ @"..chsource.."","html",true, false, false, true, reply_markup)
end
...
if text == "٠ تعيين قناة السورس ٠" then 
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(DyLer.."set:chs"..msg.sender.user_id,true)
return send(msg_chat_id,msg_id,'ارسل معرف القناه الان',"md",true)  
end
if Redis:get(DyLer.."set:rmz"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(DyLer.."set:rmz"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
Redis:set(DyLer..'rmzsource',text)
Redis:del(DyLer.."set:rmz"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ رمز السورس ',"md",true)  
dofile('DyLer.lua')  
end
end
if text == "٠ تعيين رمز السورس ٠" then 
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(DyLer.."set:rmz"..msg.sender.user_id,true)
return send(msg_chat_id,msg_id,'ارسل رمز بدل من { ↯︙ }',"md",true)  
end
if text == "٠ حذف رمز السورس ٠" then 
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(DyLer.."rmzsource","↯︙")
return send(msg_chat_id,msg_id,'تم ارجاع رمز السورس الي  { ↯︙ }',"md",true)  
end
if Redis:get(DyLer.."set:devs"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(DyLer.."set:devs"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(DyLer.."chdevolper",ch)
Redis:del(DyLer.."set:devs"..msg.sender.user_id)
...
if text == "٠ تعيين مطور السورس ٠" then 
if not msg.Devss then 
return send(msg_chat_id,msg_id,'\n*↯︙ هذا الامر يخص  '..Controller_Num(2)..' * ',"md",true)  
end
Redis:set(DyLer.."set:devs"..msg.sender.user_id,true)
