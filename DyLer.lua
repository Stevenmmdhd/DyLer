...
var(SourceCh)
if SourceCh and SourceCh.ChatMember and SourceCh.ChatMember.DyLer ~= true then
varsj = false
end 
return varsj
end
...
local N = (Redis:get(DyLer.."Name:Bot") or "ديفل")
...
{
{text = '‹ TeAm Devil ›', url = 't.me/LLQLLIL'},
}
}
...
{
{text = '❲ TeAm Devil ❳', url = "https://t.me/LLQLLIL"}
},
}
...
data = {
{
{text = '‹ TeAm Devil ›', url = 't.me/'..chsource..''}, 
},
}
}
...
if text == "زخرفه" then
  ...
  return send(msg_chat_id,msg_id, "مرحبا بك في زخرفه ديفلر","md",false,false,false,false,reply_markup)
end
-- z eng
...
return send(msg_chat_id,msg_id,"[~ Welcome to Source TeAm Devil ](tg://user?id=5984712101)","md",true, false, false, true, reply_markup)
end
...
{
{text = '- TeAm Devil ٠', url = 't.me/LLQLLIL'}, 
},
}
}
...
if text then
local GetMsg = Redis:incr(TheSeFoDev..'TheSeFoDev:Num:Message:User'..msg.chat_id..':'..msg.sender_id.user_id) 
Redis:hset(TheSeFoDev..':GroupUserCountMsg:'..msg.chat_id,msg.sender_id.user_id,GetMsg)
...
NameLUser = NameLUser:gsub("]","")
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(TheSeFoDev..':GroupNameUser:'..msg.chat_id,msg.sender_id.user_id,NameLUser)
end
if text == "تحدي" then
local Info_Members = LuaTele.searchChatMembers(msg.chat_id, "*", 200)
local List = Info_Members.members
...
if text == "تاكات" and not Redis:get(TheSeFoDev.."mnshntezt"..msg.chat_id) then
local listmnshn = {
"@ لـ 7 كله ننام سوا بفراش واحد ؟",
"@ لـ 10 تشتريلي رانج ونفتر سوا ؟",
"@ لـ 5 كله تحبني",
"@ لـ 2 كله شلابس ؟",
"@ لـ 2 كله اذا دخلت النار تجي وياي؟",
"@ لـ 10 كله نصعد اتصال ٣ ساعات ؟",
"@ لـ 7 كله اذا متت تجي بفاتحتي؟",
"@ لـ 2 كله نتزوج",
"@ لـ 6 كله همسة لطيفة",
"@ لـ 10 كله ممكن علاقة جادة",
"@ لـ 8 كله اسألني سؤال",
"@ لـ 2 كله شلون تعرفت عليه؟",
"@ لـ 8 كله نخلف جهال سوا ؟",
"@ لـ 7 كله اذا جوعان تسويلي اكل",
"@ لـ 4 كله شكد تحبني من 10",
"@ لـ 8 كله غنيلي",
"@ لـ 8 كله تعال اتنفسك صدكني مخنوك",
"@ لـ 9 كله نطيني بوسه",
"@ لـ 7 كله ننام سوا بفراش واحد ؟",
"@ لـ 10 تشتريلي رانج ونفتر سوا ؟",
"@ لـ 1 كله شلون تعرفت عليه؟",
"@ لـ 9 كله اغنية لطيفة",
"@ لـ 1 كله مشتاقلي؟",
"@ لـ 3 كله كامش عليك فضيحه",
"@ لـ 1 كله بشنو مستفاد منك ؟",
"@ لـ 1 كله نرتبط بالسر",
"@ لـ 2 كله بشنو مستفاد منك ؟",
"@ لـ 3 كله يجي يوم ونتفارك؟",
"@ لـ 3 كله اذا متت تجي بفاتحتي؟",
"@ لـ 8 كله اهديلي اغنيه",
"@ لـ 3 كله احجيلي سر عنك بهمسة ؟",
"@ لـ 3 كله نسافر لباريس سوه",
"@ لـ 4 كله حن واني احن",
"@ لـ 10 كله كلشي بغيابك يختلف ؟",
"@ لـ 3 تزوجني اخوك/اختك ؟",
"@ لـ 10 كله سكرين لخاصك ؟",
"@ لـ 6 كله هم تحس بيه؟"
}
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n*•  ديفل ماعنده حساب بالبنك 🤣*","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "حوالة صادرة من بنك ديفل\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمستلم : "..newss.."\nالحساب رقم : `"..text.."`\nنوع البطاقة : "..fsvhh.."\nخصمت 10% رسوم تحويل\nالمبلغ : "..UserNameyy.." دولار 💵","md",true)
send(fsvhhh,0, "حوالة واردة من بنك ديفل\n\nالمرسل : "..news.."\nالحساب رقم : `"..cccc.."`\nنوع البطاقة : "..uuuu.."\nالمبلغ : "..UserNameyy.." دولار 💵","md",true)
Redis:del(DyLer.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(DyLer.."transn" .. msg.sender.user_id)
else
send(msg.chat_id,msg.id, "•  مافيه حساب بنكي كذا","md",true)
...
https.request("https://api.telegram.org/bot"..Token..'/sendphoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/MoviesDyLer/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..MsgId.."&parse_mode=markdown") 
end
...
send(msg.chat_id,msg.id,"↯︙ اهلا بك في الحاسبة الرقمية الخاصة بسورس ديفل","md",true, false, false, true, start_mrkup)
return false 
end
...
local datar = {data = {{text = "‹ TeAm Devil ›" , url = 'https://t.me/LLQLLIL'}}}
for i = 1,5 do
...
photo = "https://t.me/randTeAmDevil/4"
local T =[[
↯︙Welcome To Source
↯︙[ TeAm Devil ](t.me/LLQLLIL)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '❨Dev Source❩', url = "https://t.me/Q0OO0"},{text = '❨Exp Source❩', url = "https://t.me/DGGEO"},
},
{
...
if text == (Redis:get(DyLer.."Name:Bot") or "ديفل") then
if Redis:get(DyLer.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(DyLer.."Name:Bot") or "ديفل")
    local NameBots = {
"قلب "..NamesBot ,
"كول حبيبي ؟ شرايود 😂",
...
if Redis:get(DyLer.."Status:Games"..msg.chat_id) then
KlamSpeed = {"سحور","سياره","استقبال","قنفذ","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","ديفل","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","لعبه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
...
name = string.gsub(name,"ديفل","ر و ف ر ي")
...
data = {
{
{text = '( نعم انا متاكد من حذف حسابي)', type = 'requestphone'},
},
}
}
return send(msg_chat_id,msg_id,'↯︙ فكر جيدا قبل حذف حسابك ', 'md', false, false, false, false, reply_markup)
...
local CmdStart = '*\n↯︙ اهلا بك عزيزي انا بوت '..(Redis:get(DyLer.."Name:Bot") or "ديفل")..
...
Redis:del(DyLer.."set:chs"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ معرف ‹ TeAm Devil › ',"md",true)  
dofile('DyLer.lua')  
else
send(msg_chat_id,msg_id,'المعرف خطأ ',"md",true)  
end
...
if tonumber(IdUser) == tonumber(sendrr) then
Redis:del(DyLer..IdUser..ChatId.."num")
edit(ChatId,Msg_id,"↯︙ اهلا بك في الحاسبة الرقمية الخاصة بسورس ديفل" , 'html', false, false, calc_markup)
else
LuaTele.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ DyLer',url='https://t.me/LLQLLIL'}},
}
...
local TextHelp = [[*
↯︙ أهلا بك في قائمة العاب سورس ديفل اختر نوع الالعاب 
*]]
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
↯︙ مرحبا بك في الالعاب المتطورة الخاص بسورس ديفل 
