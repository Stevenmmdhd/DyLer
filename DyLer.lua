...
if text == 'رفع' and msg.reply_to_message_id > 0 then
if not msg.Admin then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
{
{text = '- مميز : '..Specialz, data =msg.sender.user_id..'/statusSpecialz/'..Message_Reply.sender.user_id},{text = '- مطور : '..Controller, data =msg.sender.user_id..'/statusAdminz/'..Message_Reply.sender.user_id},
},
{
{text = '❨ تنفيذ واغلاق ❩', data ='/delAmr1'}
}
}
}
return send(msg.chat_id,msg.id,'*\n• رفع برتب الشخص*',"md",false, false, false, false, reply_markup)
end
