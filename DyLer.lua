...
{
{text = '‹ DyLer TeAm ›', url = 't.me/LLQLLIL'},
}
}
...
{
{text = '❲ DyLer TeAm ❳', url = "https://t.me/LLQLLIL"}
},
}
...
return send(msg_chat_id,msg_id,"[~ Welcome to Source Dyler team ](tg://user?id=5984712101)","md",true, false, false, true, reply_markup)
end
...
{
{text = '- DyLer TeAm ٠', url = 't.me/LLQLLIL'}, 
},
}
}
...
local datar = {data = {{text = "‹ DyLer TeAm ›" , url = 'https://t.me/LLQLLIL'}}}
for i = 1,5 do
