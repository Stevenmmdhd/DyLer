...
local rep = msg.id/2097152/0.5
local m = json:decode(https.request("https://api.telegram.org/bot"..Token.."/sendmessage?chat_id="..msg_chat_id.."&text="..("جار تحميل المقطع").."&reply_to_message_id="..rep)).result.message_id
